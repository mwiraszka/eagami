...
export const esES: WebMessages = {
    ...
    services: {
      ...
      core: [
        ...
        },
        {
          ...
          description:
            'Soporte mensual para alojamiento, actualizaciones de seguridad, actualizaciones de paquetes externos, revisiones de contenido y analíticas.',
        },
      ],
      addOns: [
        {
  ...
  ui: {
    ...
    icons: {
      ...
      title: 'Iconos',
      ledeBefore: 'Componentes Angular autónomos que heredan su color y se escalan con',
      ledeAfter:
        ', por lo que se renderizan a cualquier tamaño. Derivados de Feather Icons de Cole Bemis y usados bajo la licencia MIT. Haz clic en un icono para copiar su selector.',
