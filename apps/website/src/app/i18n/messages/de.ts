...
export const de: WebMessages = {
  ...
  home: {
    ...
    projects: {
      ...
      cards: [
        ...
        },
        {
          title: 'Chordbomb',
          description:
            'Erkennt den Song, der gerade läuft, und ermittelt seine Akkordfolge.',
    ...
    contact: {
      ...
      errorMessage:
        'Entschuldigung, etwas ist schiefgelaufen. Bitte schreiben Sie direkt an info@eagami.com.',
    },
  },
  privacy: {
    ...
    languageNote:
      'Diese Erklärung wird ausschließlich auf Englisch gepflegt. Übersetzte Fassungen dienen nur der besseren Verständlichkeit.',
  },
  terms: {
    metaTitle: 'Nutzungsbedingungen | Eagami',
    metaDescription:
      'Bedingungen für die Nutzung von eagami.com und der Eagami UI Komponentenbibliothek.',
    title: 'Nutzungsbedingungen',
    lastUpdated: date => `Zuletzt aktualisiert: ${date}`,
    languageNote:
      'Diese Bedingungen werden ausschließlich auf Englisch gepflegt. Übersetzte Fassungen dienen nur der besseren Verständlichkeit.',
  },
  notFound: {
    metaTitle: 'Seite nicht gefunden | Eagami',
  ...
  ui: {
    ...
    setup: {
      ...
      title: 'Einrichtung',
      ngAddLabel: 'Alles mit einem Befehl installieren und konfigurieren:',
      manualLabel: 'Oder manuell einrichten:',
    ...
    component: {
      ...
      demos: {
        ...
        alert: {
          ...
          message: 'Dies ist eine Hinweismeldung.',
        },
        autocomplete: {
        ...
        toast: {
          ...
          movedSegment: 'Verschoben: ',
          roadmapSegment: 'Q3-Roadmap',
          toSegment: ' nach ',
          archivedSegment: 'Archivierte Projekte',
        ...
        commandPalette: {
          ...
          toggleThemeDescription: 'Zwischen hellem und dunklem Modus wechseln',
        ...
        stepper: {
          accountLabel: 'Konto',
          accountContent: 'Schritt 1: Kontodaten.',
          profileLabel: 'Profil',
          profileContent: 'Schritt 2: Profilangaben.',
          reviewLabel: 'Überprüfung',
          reviewContent: 'Schritt 3: prüfen und absenden.',
        },
        timeline: {
          orderPlaced: 'Bestellung aufgegeben',
          orderPlacedDescription: 'Zahlung bestätigt und Beleg versendet.',
          packed: 'Verpackt',
          packedDescription: 'Artikel im Lager kommissioniert und verpackt.',
          outForDelivery: 'In Zustellung',
          outForDeliveryDescription: 'Der Kurier ist unterwegs.',
          delivered: 'Zugestellt',
          deliveredDescription: 'Voraussichtlich bis Tagesende.',
      ...
      playground: {
        ...
        knobDefaults: {
          autocomplete: {
            ...
            firstGroupLabel: 'Zuletzt verwendet',
            secondGroupLabel: 'Alles andere',
          },
          avatar: {
            alt: 'Benutzer-Avatar',
          },
          ...
          'command-palette': {
            ...
            emptyMessage: 'Keine passenden Befehle',
          },
          'date-picker': {
            label: 'Termindatum',
          },
          ...
          dropdown: {
            label: 'Obst',
            placeholder: 'Obst auswählen…',
            firstGroupLabel: 'Zuletzt verwendet',
            secondGroupLabel: 'Alles andere',
          },
          'empty-state': {
            title: 'Noch keine Einträge',
            description: 'Legen Sie los, indem Sie Ihren ersten Eintrag erstellen.',
          },
          'file-uploader': {
            label: 'Anhänge',
          },
          'form-field': {
            ...
            hint: 'Wir nutzen sie nur, um Sie zu erreichen',
          },
          input: {
            label: 'Beschriftung',
          ...
          rating: {
            label: 'Bewerten Sie Ihre Erfahrung',
          },
          segmented: {
            label: 'Ansicht',
          },
          ...
          switch: {
            label: 'Schalt mich um',
          },
          tag: {
            removeLabel: 'Tag entfernen',
          },
          textarea: {
            label: 'Nachricht',
          ...
          tooltip: {
            eaTooltip:
              'Tooltips liefern zusätzlichen Kontext beim Überfahren oder Fokussieren',
          },
          tree: {
            ariaLabel: 'Dateibaum',
          },
