  ...
  ui: {
    changelog: {
      ...
      lede: (pkg, version, history) =>
        `以下是 ${pkg} 库自 ${version} 版本以来的所有重要更新。完整历史请查看${history}。`,
      historyInline: 'GitHub 上的 CHANGELOG.md',
      migrationGuide: '迁移指南',
    },
    shell: {
      changelog: '更新日志',
      ...
      playground: {
        ...
        descriptions: {
          ...
          'number-input': {
            ...
            readonly: '将字段渲染为只读。',
            required: '将字段标记为必填。',
            min: '最小值；失去焦点时输入的值会被限制到该值。',
            max: '最大值；失去焦点时输入的值会被限制到该值。',
            step: '使用方向键时每一步增加或减少的量。',
            maxDigits: '限制字段接受的字符数及其显示宽度；未设置时为六个字符。',
            id: '应用于原生输入和 label for 的 id，省略时自动生成。',
          ...
          'date-picker': {
            ...
            hint: '显示在字段下方的辅助文本，在显示错误时隐藏。',
            id: '应用于字段和 label for 的 id，省略时自动生成。',
            label: '渲染在字段上方的文本标签。',
          ...
          stepper: {
            ...
            orientation: '步骤的排列轴向；在一行放不下时改为纵向堆叠。',
