...
export const ptBR: WebMessages = {
  ...
  ui: {
    ...
    index: {
      ...
      comparison: {
        heading: 'Comparativo',
        lede: 'As escolhas que moldam o trabalho diário com uma biblioteca de componentes Angular, lado a lado.',
        rows: [
          {
            feature: 'Modelo de estilização',
            eagami: 'Propriedades personalizadas de CSS',
            material: 'Sass e tokens do Material 3',
            primeng: 'Tokens de design e presets de tema',
            spartan: 'Tailwind CSS, copiado para o seu app',
          },
          {
            feature: 'Traduções integradas',
            eagami: '15 idiomas, alternáveis em tempo de execução',
            material: 'Você fornece as suas',
            primeng: 'Você fornece as suas',
            spartan: 'Você fornece as suas',
          },
          {
            feature: 'Exige um framework CSS',
            eagami: 'Não',
            material: 'Não',
            primeng: 'Não',
          ...
          {
            feature: 'Dependências além do Angular',
            eagami: 'Nenhuma',
            material: 'Angular CDK',
            primeng: 'Angular CDK e pacotes PrimeUIX',
            spartan: 'Angular CDK, Tailwind CSS e pacotes utilitários',
          },
        ],
      },
    },
    ...
    integrations: {
      ...
      intro:
        'Os tokens de design do Eagami são independentes de framework. Copie um guia de integração autônomo para um projeto sem Angular ou consuma diretamente a exportação de tokens legível por máquina.',
    ...
    tokens: {
      ...
      lede: 'Tokens de design são as propriedades personalizadas de CSS que governam cada componente da biblioteca: cores, tipografia, espaçamento, elevação, forma e movimento. Referencie esses tokens em seus próprios estilos via <code>var(--token-name)</code> para manter a consistência visual em todo o aplicativo.',
      sections: {
        theming: 'Temas',
      ...
      themingRootBefore:
        'Cada token de design do Eagami pode ser sobrescrito, então a biblioteca se adapta a qualquer marca. Sobrescreva qualquer token em <code>:root</code> para retematizar toda a biblioteca:',
      themingScopedBefore:
      ...
      paletteContrast:
        'Cada combinação de papel da marca (texto sobre superfície, superfície sobre tela) é verificada em relação ao <a href="https://www.w3.org/TR/WCAG22/" target="_blank" rel="noopener noreferrer"><span>WCAG 2.2 Level AA</span></a> na inicialização. Uma combinação que falha lança um erro antes do aplicativo carregar, então um problema de contraste na cor da marca é detectado na inicialização em vez de em produção.',
      ...
      integrationsIntro:
        'Todos os tokens de design acima são independentes de framework. Para projetos sem Angular, basta passar um guia de integração autônomo para o seu agente de IA, ou deixá-lo consumir diretamente a exportação de tokens legível por máquina.',
    },
    icons: {
    ...
    i18n: {
      ...
      quickSetupBefore:
        'Adicione <code>provideEagamiUi()</code> à configuração do seu aplicativo e registre os idiomas que você usa via <code>locales</code>. O inglês está sempre incluído, e apenas os idiomas que você registra são adicionados ao seu bundle.',
    ...
    component: {
      ...
      demos: {
        ...
        toast: {
          ...
          movedSegment: 'Movido: ',
          roadmapSegment: 'Roteiro do 3º trimestre',
          toSegment: ' para ',
          archivedSegment: 'Projetos arquivados',
        ...
        commandPalette: {
          ...
          toggleThemeDescription: 'Alterna entre o modo claro e o escuro',
          lockWorkspace: 'Bloquear a área de trabalho',
          lockWorkspaceDescription: 'Desativado no momento (recurso em beta)',
          fileGroup: 'Arquivo',
          editGroup: 'Editar',
        ...
        stepper: {
          accountLabel: 'Conta',
          accountContent: 'Etapa 1: dados da conta.',
          profileLabel: 'Perfil',
          profileContent: 'Etapa 2: informações do perfil.',
          reviewLabel: 'Revisão',
          reviewContent: 'Etapa 3: revisar e enviar.',
        },
        timeline: {
          orderPlaced: 'Pedido realizado',
          orderPlacedDescription: 'Pagamento confirmado e recibo enviado.',
          packed: 'Embalado',
          packedDescription: 'Itens separados e embalados no depósito.',
          outForDelivery: 'Saiu para entrega',
          outForDeliveryDescription: 'O entregador está a caminho.',
          delivered: 'Entregue',
          deliveredDescription: 'Previsto até o fim do dia.',
      ...
      playground: {
        ...
        knobDefaults: {
          autocomplete: {
            ...
            firstGroupLabel: 'Usados recentemente',
            secondGroupLabel: 'Todo o restante',
          },
          avatar: {
          ...
          'command-palette': {
            ...
            emptyMessage: 'Nenhum comando correspondente',
          },
          'date-picker': {
          ...
          'form-field': {
            ...
            hint: 'Usamos apenas para entrar em contato com você',
          },
          input: {
            label: 'Rótulo',
          ...
          tooltip: {
            eaTooltip: 'As dicas adicionam contexto ao passar o cursor ou focar',
          },
          tree: {
            ariaLabel: 'Árvore de arquivos',
          },
        },
      },
      sharedOptions: {
