  ...
  ui: {
    ...
    index: {
      ...
      principles: [
        ...
        {
          title: 'Локалізований',
          body: 'Вбудований текст компонентів постачається дванадцятьма мовами.',
        },
        {
          title: 'Сучасний',
    ...
    i18n: {
      ...
      metaDescription:
        'Вбудований текст компонентів дванадцятьма мовами, з перемиканням під час виконання та перевизначеннями для окремих рядків.',
      title: 'Інтернаціоналізація',
      lede: 'Кожен вбудований рядок (ARIA-мітки, заповнювачі, порожні стани, елементи керування вибору дати) постачається дванадцятьма мовами. Встановіть одну для всього застосунку, перемикайте під час виконання або перевизначайте окремі рядки.',
    ...
    component: {
      ...
      playground: {
        ...
        descriptions: {
          ...
          drawer: {
            animated: 'Висуває панель з її краю, коли висувна панель відкривається.',
            ariaLabel:
            ...
            width: 'Ширина висувної панелі вздовж її основної осі.',
            closed:
              'Спрацьовує, коли висувна панель закривається, чи то через кнопку закриття, підкладку або Escape.',
            opened: 'Спрацьовує, щойно висувну панель показано через showModal().',
          },
          'data-table': {
            clickable:
