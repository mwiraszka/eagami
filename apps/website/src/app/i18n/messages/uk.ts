  ...
  ui: {
    changelog: {
      ...
      lede: (pkg, version, history) =>
        `Нижче наведено всі помітні зміни бібліотеки ${pkg}, починаючи з версії ${version}. Повну історію можна переглянути у ${history}.`,
      historyInline: 'файлі CHANGELOG.md на GitHub',
    ...
    component: {
      ...
      demos: {
        ...
        tooltip: {
          ...
          templateTriggerLabel: '(наведи для підказки з шаблону)',
          templateTipStatus: 'Зараз онлайн',
          topLabel: 'Зверху',
        ...
        lineChart: {
          ...
          signUps: 'Реєстрації',
          months: ['січ.', 'лют.', 'бер.', 'квіт.', 'трав.', 'черв.', 'лип.', 'серп.'],
        },
        pieChart: {
          desktop: 'Комп’ютер',
          mobile: 'Телефон',
      ...
      playground: {
        ...
        knobLabels: {
          'bar-chart': {
            ...
            size: 'Розмір',
            animation: 'Анімація',
            animationDuration: 'Тривалість анімації (ms)',
            height: 'Висота (px)',
            stacked: 'З накопиченням',
            showValues: 'Показати значення',
          ...
          'line-chart': {
            ...
            animationDuration: 'Тривалість анімації (ms)',
            height: 'Висота (px)',
            showArea: 'Показати область',
            showPoints: 'Показати точки',
            showGrid: 'Показати сітку',
            showLegend: 'Показати легенду',
          },
          'pie-chart': {
        ...
        descriptions: {
          'bar-chart': {
            labels: 'Підписи категорій уздовж осі категорій, по одному на значення.',
            series:
              'Ряди для відображення, кожен з назвою, одним значенням на підпис і необов’язковим кольором.',
            orientation: 'Напрямок, у якому стовпці відходять від базової лінії.',
            stacked:
              'Об’єднує ряди кожного підпису в один стовпець замість групування поруч.',
            showGrid: 'Малює лінії сітки на кожній поділці осі значень.',
            showLegend: 'Показує легенду під діаграмою, коли на ній більше одного ряду.',
            showValues:
              'Виводить значення кожного стовпця біля його кінця, а в режимі накопичення підсумок кожного стосу.',
            height: 'Висота області побудови в пікселях; ширина заповнює контейнер.',
            size: 'Візуальний розмір тексту осі, легенди та підказки.',
            animation:
              'Анімація появи, що повторюється за кожної зміни даних: зростання від базової лінії, каскад підпис за підписом, плавна поява або без анімації.',
            animationDuration: 'Тривалість анімації появи в мілісекундах.',
            formatValue:
              'Форматує значення на осі, у підказці та в таблиці даних; за замовчуванням групуються згідно з активною локаллю.',
            pointClick:
              'Спрацьовує, коли на стовпець клацають або вибирають його клавішею Enter чи пробілом.',
            activePointChange:
              'Спрацьовує, коли виділений стовпець змінюється вказівником або з клавіатури, зі значенням null після зняття виділення.',
          },
          'line-chart': {
            labels: 'Підписи категорій уздовж осі x, по одному на значення.',
            series:
              'Ряди для відображення, кожен з назвою, одним значенням на підпис (null залишає розрив) і необов’язковим кольором.',
            curve: 'Як лінія вигинається між точками.',
            showArea: 'Заливає область під кожною лінією світлим відтінком її кольору.',
            showPoints: 'Позначає кожне значення точкою.',
            showGrid: 'Малює горизонтальні лінії сітки на кожній поділці осі y.',
            showLegend: 'Показує легенду під діаграмою, коли на ній більше одного ряду.',
            yMin: 'Нижня межа осі y; обчислюється з даних, якщо не задана.',
            yMax: 'Верхня межа осі y; обчислюється з даних, якщо не задана.',
            height: 'Висота області побудови в пікселях; ширина заповнює контейнер.',
            size: 'Візуальний розмір тексту осі, легенди та підказки.',
            animation:
              'Анімація появи, що повторюється за кожної зміни даних: промальовування кожної лінії, розкриття зліва направо, плавна поява, підйом від базової лінії або без анімації.',
            animationDuration: 'Тривалість анімації появи в мілісекундах.',
            formatValue:
              'Форматує значення на осі, у підказці та в таблиці даних; за замовчуванням групуються згідно з активною локаллю.',
            pointClick:
              'Спрацьовує, коли на точку клацають або вибирають її клавішею Enter чи пробілом.',
            activePointChange:
              'Спрацьовує, коли виділена точка змінюється вказівником або з клавіатури, зі значенням null після зняття виділення.',
          },
          'pie-chart': {
            data: 'Сегменти, що малюються за годинниковою стрілкою від позначки дванадцятої години, кожен з підписом, значенням і необов’язковим кольором.',
            variant: 'Суцільне коло або кільце з порожнім центром.',
            showLegend: 'Показує під діаграмою легенду всіх сегментів.',
            showPercentages:
              'Додає до запису легенди кожного сегмента його частку від загальної суми.',
            height:
              'Найбільший діаметр діаграми в пікселях; вона зменшується, щоб поміститися у вужчий контейнер.',
            size: 'Візуальний розмір тексту легенди та підказки.',
            animation:
              'Анімація появи, що повторюється за кожної зміни даних: розгортання за годинниковою стрілкою, зростання з центру, плавна поява або без анімації.',
            animationDuration: 'Тривалість анімації появи в мілісекундах.',
            formatValue:
              'Форматує значення в підказці та в таблиці даних; за замовчуванням групуються згідно з активною локаллю.',
            sliceClick:
              'Спрацьовує, коли на сегмент клацають або вибирають його клавішею Enter чи пробілом.',
            activeSliceChange:
              'Спрацьовує, коли виділений сегмент змінюється вказівником або з клавіатури, зі значенням null після зняття виділення.',
          },
          timeline: {
          ...
          toast: {
            size: 'Візуальний розмір, застосований до кожного тоста в стеку.',
            position: 'Кут або край вікна перегляду, до якого прикріплено стек тостів.',
            clearable: 'Показує кнопку закриття на кожному тості.',
            show: 'Показує тост і повертає його id. Його повідомлення та заголовок приймають звичайний рядок або сегменти з акцентом.',
            success: 'Показує тост про успіх і повертає його id.',
            error: 'Показує тост про помилку і повертає його id.',
            warning: 'Показує тост із попередженням і повертає його id.',
            info: 'Показує інформаційний тост і повертає його id.',
            dismiss: 'Видаляє тост із вказаним id, якщо він ще показаний.',
            clear: 'Видаляє всі показані наразі тости.',
            pause:
              'Призупиняє всі відліки автоматичного закриття, зберігаючи час, що лишився кожному тосту.',
            resume: 'Відновлює відліки, призупинені pause.',
          },
          input: {
            spellcheck:
              'Значення нативного атрибута spellcheck, а якщо не задано, діє типова поведінка браузера.',
            keepIcon:
              'Зберігає провідну піктограму видимою, поки поле має значення; при false піктограма зʼявляється лише разом із плейсхолдером.',
            role: 'Роль ARIA, застосована до нативного поля, наприклад combobox для typeahead.',
            ariaExpanded:
              'Стан розгортання керованого спливаючого списку, передається як aria-expanded.',
            ariaControls:
              'id спливаючого елемента, яким керує поле, передається як aria-controls.',
            ariaActivedescendant:
              'id активного пункту в керованому спливаючому списку, передається як aria-activedescendant.',
            ariaAutocomplete:
              'Підказка поведінки автозаповнення, передається як aria-autocomplete.',
            labelIcon:
              "Необов'язковий компонент значка, що відображається перед текстом підпису.",
          ...
          'number-input': {
            ...
            readonly: 'Рендерить поле лише для читання.',
            required: 'Позначає поле як обов’язкове.',
            min: 'Мінімальне значення; введені значення обмежуються ним при втраті фокуса.',
            max: 'Максимальне значення; введені значення обмежуються ним при втраті фокуса.',
            step: 'Величина, яку кожен крок стрілками додає або віднімає.',
            maxDigits:
              'Обмежує кількість символів, які приймає поле, та його ширину; шість символів, якщо не задано.',
            id: 'id, що застосовується до нативного input і label for, генерується автоматично, якщо пропущено.',
            value:
          ...
          accordion: {
            size: 'Візуальний розмір акордеона; кожен елемент успадковує його.',
          ...
          badge: {
            ...
            uppercase: 'Відображає вміст повністю великими літерами.',
          },
          button: {
            ...
            uppercase: 'Відображає мітку повністю великими літерами.',
          ...
          checkbox: {
            truncate: 'Обрізає надто довгий підпис і показує повний текст у підказці.',
          ...
          'color-picker': {
            compact:
              'Показує тригер як простий зразок кольору, без значення та кнопки очищення.',
            disabled: 'Вимикає поле.',
            errorMsg:
              'Повідомлення про помилку під полем, що замінює підказку та позначає поле недійсним.',
          ...
          'eagami-wordmark': {
            variant:
              'Варіант вмісту: default це чистий вордмарк, byline додає рядок «дизайн від», tagline додає слоган.',
            layout: 'Розташовує вордмарк у стос по рядках або вбудовано в один рядок.',
            size: 'Розмір шрифту тексту бренду в px; решта вордмарка масштабується від нього.',
            linked:
              'Показує вордмарк як посилання на eagami.com; вимкніть, щоб вбудувати його у власне посилання або статичний контекст.',
          },
          'empty-state': {
          ...
          paginator: {
            ...
            showAllOption:
              'Пропонує після варіантів розмір сторінки «Усі», передаючи при виборі PAGE_SIZE_ALL як розмір сторінки.',
            pageSizeLabel:
              'Що рахує вибір розміру сторінки: локалізований підпис «Рядків», «Елементів», «Результатів», «Товарів», «Записів», «Позицій», «Дописів» або «Статей» на сторінці.',
          },
          'progress-bar': {
          ...
          slider: {
            ...
            snapValues:
              'Значення, до яких повзунок примагнічується під час перетягування; кожне позначене рискою на шкалі.',
          ...
          tag: {
            color:
              'Колір заливки у шістнадцятковому вигляді: фарбує тег і добирає читабельний колір тексту.',
            variant: 'Семантична кольорова схема тега.',
            size: 'Візуальний розмір тега.',
            maxWidth:
              'Максимальна ширина тегу в px; довший підпис обрізається. Також задається через --ea-tag-max-width.',
            tooltip:
              'Де підпис, обрізаний maxWidth, показує повний текст: над тегом чи під ним, або none, щоб приховати його.',
            ...
            removeTabbable:
              'Чи є кнопка видалення зупинкою табуляції; задайте false всередині складеного віджета, який сам керує навігацією клавіатурою.',
            removed:
          ...
          tooltip: {
            tooltipOpen:
              'Програмно показує або приховує підказку для тригера, на який не наводять вказівник і не ставлять фокус; null залишає це наведенню та фокусу.',
            whenClipped: 'Показує підказку, лише поки тригер обрізає власний вміст.',
            flip: 'Переносить підказку на протилежний бік, якщо із запитаного немає місця.',
            maxWidth:
              'Максимальна ширина в пікселях; текст переноситься на цій ширині (нижня межа 50px). Підказка ніколи не виходить за межі вікна перегляду.',
            dismissDelay:
              'Затримка в мілісекундах перед приховуванням прокручуваної підказки після відведення вказівника, достатня, щоб навести на неї. Підказки, які вміщуються, зникають одразу.',
            eaTooltip:
              'Вміст підказки, що показується при наведенні та фокусі з клавіатури. Приймає звичайний рядок або TemplateRef для стилізованого вмісту.',
          ...
          autocomplete: {
            ...
            options:
              'Повний список варіантів, доступних для фільтрування та вибору, плоский або розділений на групи.',
            placeholder: 'Заповнювач, що показується, поки поле порожнє.',
            readonly: 'Рендерить поле лише для читання.',
            required: 'Позначає поле як обов’язкове.',
            size: 'Візуальний розмір поля.',
          ...
          'command-palette': {
            disabledWhen:
              'Необов’язковий предикат, що вимикає кожен елемент, для якого він повертає true, додатково до власного прапорця disabled елемента.',
            emptyMessage:
          ...
          'date-picker': {
            ...
            hint: 'Допоміжний текст під полем, прихований, поки показується помилка.',
            id: 'id, що застосовується до поля і label for, генерується автоматично, якщо пропущено.',
            labelIcon:
              "Необов'язковий компонент значка, що відображається перед текстом підпису.",
            label: 'Текстова мітка, що рендериться над полем.',
            locale:
            ...
            placeholder: 'Заповнювач, що показується в полі, поки дату не обрано.',
            readonly: 'Рендерить поле лише для читання, не даючи календарю відкритися.',
            required: 'Позначає поле як обов’язкове.',
            size: 'Візуальний розмір поля вибору дати.',
            ...
            focus: 'Переміщує фокус клавіатури на поле дати.',
            onPopoverCloseRequested:
          ...
          menu: {
            size: 'Візуальний розмір меню; кожен елемент успадковує його.',
            maxHeight:
          ...
          'multi-select': {
            created: 'Спрацьовує з введеним текстом, коли обрано рядок створення.',
            allowCreate:
              'Пропонує рядок створення, коли текст пошуку не збігається з жодною опцією.',
            ...
            maxChipWidth:
              'Максимальна ширина чипа обраного значення в px; довший підпис обрізається і показує повний текст у підказці.',
            popoverMaxHeight:
              'Максимальна висота списку варіантів у px, після якої список прокручується.',
            popoverMaxWidth:
              'Максимальна ширина списку варіантів у px або anchor, щоб обмежити її шириною поля.',
            options:
              'Список варіантів для вибору, що рендеряться у випадному списку, плоский або розділений на групи.',
          ...
          'file-uploader': {
            ...
            dragOverChanged:
              'Спрацьовує, коли перетягування входить у зону скидання або залишає її, для обгортки з власним стилем перетягування.',
            rejected:
          ...
          'form-field': {
            size: 'Візуальний розмір поля; мітка, текст елемента керування, відступи та повідомлення масштабуються разом із ним.',
            errorMsg:
          ...
          popover: {
            ...
            maxWidth:
              'Максимальна ширина поверхні в px або anchor, щоб обмежити її шириною якірного елемента.',
          ...
          breadcrumbs: {
            size: 'Візуальний розмір стежки хлібних крихт.',
            ariaLabel:
          ...
          'data-table': {
            nowrap:
              'Тримає кожну комірку в один рядок, тож у вузькому вікні таблиця прокручується вбік замість переносити текст.',
            rowHref:
              'Задає кожному рядку ціль посилання, розміщену справжнім посиланням у кожній комірці, щоб браузер показував і міг відкрити її, а звичайний клік і далі викликав rowActivate. Рядок, для якого вона повертає null, лишається інертним: без посилання, підсвічування при наведенні, фокуса й активації.',
            sizingRows:
              'Рядки з найширшим вмістом кожного стовпця, які розмічаються, але ніколи не показуються, щоб ширина стовпців не змінювалася між сторінками та під час завантаження даних.',
            size: 'Візуальний розмір таблиці; відступи щільності та іконки масштабуються разом із ним.',
            clickable:
            ...
            caption:
              'Видимий підпис, що відображається над таблицею; також задає її ім’я для допоміжних технологій.',
            columns:
          ...
          stepper: {
            ...
            orientation:
              'Вісь, уздовж якої розташовані кроки; розміщуйте їх вертикально там, де рядок не вміщується.',
          ...
          'field-label': {
            ...
            icon: "Необов'язковий компонент значка, що відображається перед текстом підпису.",
            labelId:
          ...
          dialog: {
            closeRequested:
              'Спрацьовує за manualClose на кожну спробу закриття, не закриваючи діалог.',
            manualClose:
              'Повідомляє про кожне закриття через closeRequested і залишає діалог відкритим, доки open не стане false.',
            modal:
              'Показує діалог як модальний із підкладкою; при false він відображається немодально, а сторінка позаду залишається прокручуваною та інтерактивною.',
            closeDisabled:
              'Вимикає вбудовану кнопку закриття, наприклад поки триває збереження.',
            ariaLabel:
