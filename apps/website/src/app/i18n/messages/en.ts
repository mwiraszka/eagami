...
export const en: WebMessages = {
  ...
  ui: {
    ...
    icons: {
      ...
      title: 'Icons',
      ledeBefore: 'Standalone Angular components that inherit their color and scale with',
      ledeAfter:
        ', so they render at any size. Derived from Feather Icons by Cole Bemis and used under the MIT License. Click an icon to copy its selector.',
