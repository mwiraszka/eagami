      ...
      playground: {
        ...
        descriptions: {
          ...
          'data-table': {
            ...
            rowHref:
              'Δίνει σε κάθε γραμμή έναν προορισμό συνδέσμου, ως πραγματικό σύνδεσμο σε κάθε κελί ώστε το πρόγραμμα περιήγησης να τον εμφανίζει και να μπορεί να τον ανοίξει, ενώ ένα απλό κλικ εξακολουθεί να εκπέμπει rowActivate.',
            sizingRows:
