...
export const el: WebMessages = {
  ...
  ui: {
    ...
    index: {
      ...
      principles: [
        ...
        },
        {
          ...
          body: 'Τα ενσωματωμένα κείμενα των συστατικών είναι διαθέσιμα σε δώδεκα γλώσσες.',
        },
        {
          title: 'Σύγχρονο',
    ...
    i18n: {
      ...
      metaDescription:
        'Ενσωματωμένα κείμενα συστατικών σε δώδεκα γλώσσες, με εναλλαγή κατά την εκτέλεση και παρακάμψεις ανά συμβολοσειρά.',
      title: 'Διεθνοποίηση',
      lede: 'Κάθε ενσωματωμένη συμβολοσειρά (ετικέτες ARIA, σύμβολα κράτησης θέσης, κενές καταστάσεις, χειριστήρια επιλογέα ημερομηνίας) στέλνεται σε δώδεκα γλώσσες. Ορίστε μία για όλη την εφαρμογή, αλλάξτε κατά την εκτέλεση ή παρακάμψτε μεμονωμένες συμβολοσειρές.',
