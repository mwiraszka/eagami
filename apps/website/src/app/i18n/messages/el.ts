      ...
      playground: {
        ...
        descriptions: {
          ...
          'number-input': {
            ...
            readonly: 'Εμφανίζει το πεδίο μόνο για ανάγνωση.',
            required: 'Επισημαίνει το πεδίο ως υποχρεωτικό.',
            min: 'Ελάχιστη τιμή. Οι πληκτρολογημένες τιμές περιορίζονται σε αυτήν κατά την απώλεια εστίασης και τα κουμπιά βημάτων τη σέβονται.',
            max: 'Μέγιστη τιμή. Οι πληκτρολογημένες τιμές περιορίζονται σε αυτήν κατά την απώλεια εστίασης και τα κουμπιά βημάτων τη σέβονται.',
            step: 'Ποσό που προσθέτει ή αφαιρεί κάθε βήμα (πλήκτρο βέλους ή κουμπί βήματος).',
            id: 'id που εφαρμόζεται στο εγγενές πεδίο και στο for της ετικέτας, δημιουργείται αυτόματα αν παραλειφθεί.',
            value:
