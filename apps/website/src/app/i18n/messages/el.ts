  ...
  ui: {
    changelog: {
      ...
      lede: (pkg, version, history) =>
        `Παρακάτω θα βρείτε όλες τις αξιοσημείωτες αλλαγές στη βιβλιοθήκη ${pkg} από την έκδοση ${version} και μετά. Για το πλήρες ιστορικό, δείτε το ${history}.`,
      historyInline: 'CHANGELOG.md στο GitHub',
    ...
    index: {
      ...
      principles: [
        ...
        },
        {
          ...
          body: 'Τα ενσωματωμένα κείμενα των συστατικών είναι διαθέσιμα σε όλες τις υποστηριζόμενες γλώσσες.',
        },
        {
          title: 'Σύγχρονο',
      ...
      showcase: {
        ...
        option2: 'Επιλογή 2',
        option3: 'Επιλογή 3',
        toastButton: 'Το κουμπί πατήθηκε',
        toastToggleOn: 'Ο διακόπτης ενεργοποιήθηκε',
        toastToggleOff: 'Ο διακόπτης απενεργοποιήθηκε',
        toastTickOn: 'Το πλαίσιο επιλέχθηκε',
        toastTickOff: 'Το πλαίσιο αποεπιλέχθηκε',
        ariaView: 'Προβολή επίδειξης',
        ariaSlider: 'Ρυθμιστικό επίδειξης',
        ariaRating: 'Αξιολόγηση επίδειξης',
        ariaLayout: 'Διάταξη επίδειξης',
        ariaColor: 'Χρώμα επίδειξης',
        ariaSelect: 'Επιλογέας επίδειξης',
        ariaDate: 'Ημερομηνία επίδειξης',
        ariaMultiSelect: 'Πολλαπλή επιλογή επίδειξης',
        msMusic: 'Μουσική',
        msTravel: 'Ταξίδια',
        msFood: 'Φαγητό',
      },
      theme: {
        ...
        ledeAfter:
          ' είναι αυτά που δίνουν σε κάθε έργο Eagami μια ξεχωριστή προσωπικότητα: προσαρμόσιμα χρώματα, γραμματοσειρές, αποστάσεις, γωνίες, σκιές και κίνηση, όλα εφαρμοσμένα σε ολόκληρο τον ιστότοπο ή την εφαρμογή. Τροποποιήστε μερικά παρακάτω για να δείτε πώς επηρεάζουν τα στοιχεία.',
        brandColor: 'Χρώμα επωνυμίας',
        radius: 'Ακτίνα γωνίας',
        font: 'Γραμματοσειρά',
        fontDefault: '(προεπιλογή)',
        reset: 'Επαναφορά',
      },
      comparison: {
        heading: 'Σε σύγκριση',
        lede: 'Οι επιλογές που διαμορφώνουν την καθημερινή εργασία με μια βιβλιοθήκη στοιχείων Angular, δίπλα δίπλα.',
        rows: [
          {
            feature: 'Μοντέλο στυλ',
            eagami: 'Προσαρμοσμένες ιδιότητες CSS',
            material: 'Sass και tokens Material 3',
            primeng: 'Design tokens και προεπιλογές θέματος',
            spartan: 'Tailwind CSS, αντιγραμμένο στην εφαρμογή σας',
          },
          {
            feature: 'Ενσωματωμένες μεταφράσεις',
            eagami: '15 γλώσσες, με εναλλαγή κατά την εκτέλεση',
            material: 'Τις παρέχετε εσείς',
            primeng: 'Τις παρέχετε εσείς',
            spartan: 'Τις παρέχετε εσείς',
          },
          {
            feature: 'Απαιτεί CSS framework',
            eagami: 'Όχι',
            material: 'Όχι',
            primeng: 'Όχι',
          ...
          {
            feature: 'Εξαρτήσεις πέρα από το Angular',
            eagami: 'Καμία',
            material: 'Angular CDK',
            primeng: 'Angular CDK και πακέτα PrimeUIX',
            spartan: 'Angular CDK, Tailwind CSS και βοηθητικά πακέτα',
          },
        ],
      },
    },
    ...
    integrations: {
      ...
      intro:
        'Τα tokens σχεδίασης του Eagami είναι ανεξάρτητα από το framework. Αντιγράψτε έναν αυτόνομο οδηγό ενσωμάτωσης σε ένα έργο εκτός Angular ή χρησιμοποιήστε απευθείας την εξαγωγή tokens σε μηχανικά αναγνώσιμη μορφή.',
    ...
    tokens: {
      ...
      lede: 'Τα tokens σχεδίασης είναι οι προσαρμοσμένες ιδιότητες CSS που οδηγούν κάθε συστατικό της βιβλιοθήκης: χρώματα, τυπογραφία, αποστάσεις, ανύψωση, σχήμα και κίνηση. Αναφέρετε αυτά τα tokens στα δικά σας στυλ μέσω <code>var(--token-name)</code> για να διατηρήσετε την οπτική συνέπεια σε όλη την εφαρμογή.',
      sections: {
        theming: 'Θέματα',
      ...
      themingRootBefore:
        'Κάθε token σχεδίασης του Eagami μπορεί να παρακαμφθεί, ώστε η βιβλιοθήκη να προσαρμόζεται σε οποιοδήποτε brand. Παρακάμψτε οποιοδήποτε token στο <code>:root</code> για να αλλάξετε το θέμα όλης της βιβλιοθήκης:',
      themingScopedBefore:
      ...
      paletteContrast:
        'Κάθε ζευγάρι ρόλων μάρκας (κείμενο πάνω σε επιφάνεια, επιφάνεια πάνω σε καμβά) ελέγχεται έναντι του <a href="https://www.w3.org/TR/WCAG22/" target="_blank" rel="noopener noreferrer"><span>WCAG 2.2 Level AA</span></a> στην εκκίνηση. Ένας μη συμβατός συνδυασμός ρίχνει σφάλμα πριν φορτώσει η εφαρμογή, οπότε ένα bug αντίθεσης στο χρώμα της μάρκας πιάνεται στο boot και όχι στην παραγωγή.',
      ...
      integrationsIntro:
        'Όλα τα παραπάνω tokens σχεδίασης είναι ανεξάρτητα από το framework. Για έργα εκτός Angular, απλώς δώστε έναν αυτόνομο οδηγό ενσωμάτωσης στον AI agent σας, ή αφήστε τον να χρησιμοποιήσει απευθείας την εξαγωγή tokens σε μηχανικά αναγνώσιμη μορφή.',
    },
    icons: {
    ...
    i18n: {
      ...
      quickSetupBefore:
        'Προσθέστε το <code>provideEagamiUi()</code> στη διαμόρφωση της εφαρμογής σας και δηλώστε τις γλώσσες που χρησιμοποιείτε μέσω <code>locales</code>. Τα αγγλικά περιλαμβάνονται πάντα, και στο bundle προστίθενται μόνο οι γλώσσες που δηλώνετε.',
      lazyHeading: 'Καθυστερημένη φόρτωση',
      lazyBefore:
        'Καταχωρίστε <code>localeLoaders</code> αντί για <code>locales</code>: μια γλώσσα κατεβαίνει την πρώτη φορά που ενεργοποιείται και μένει εκτός του αρχικού bundle. Στρέψτε κάθε loader σε ένα module που επανεξάγει ένα μόνο πακέτο γλώσσας και προφορτώστε με το <code>loadLocale()</code> όταν η εναλλαγή πρέπει να είναι άμεση.',
    ...
    accessibility: {
      ...
      lede: 'Κάθε συστατικό είναι χτισμένο σύμφωνα με τα κορυφαία πρότυπα προσβασιμότητας του ιστού: σωστή σημασιολογία, πλήρης υποστήριξη πληκτρολογίου, διαχείριση εστίασης και ανακοινώσεις για αναγνώστες οθόνης λειτουργούν άμεσα.',
      conformanceHeading: 'Συμμόρφωση',
      conformanceBody:
        'Η βιβλιοθήκη συμμορφώνεται με το <a href="https://www.w3.org/TR/WCAG22/" target="_blank" rel="noopener">WCAG 2.2 Level AA</a>, το πρότυπο που οι περισσότεροι οργανισμοί υποχρεούνται να πληρούν, και ακολουθεί τις επίσημες πρακτικές συγγραφής του W3C για κάθε είδος χειριστηρίου, από παράθυρα διαλόγου και μενού μέχρι slider και επιλογείς ημερομηνίας. Οι ανακοινώσεις για αναγνώστες οθόνης παρέχονται σε κάθε υποστηριζόμενη γλώσσα, οπότε οι υποστηρικτικές τεχνολογίες μιλούν πάντα τη γλώσσα του χρήστη.',
      builtInHeading: 'Ενσωματωμένη προσβασιμότητα',
      builtInItems: [
        {
          title: 'Σημασιολογία',
          body: 'Εγγενή στοιχεία όπου είναι δυνατόν, ρητοί ρόλοι, καταστάσεις και ιδιότητες ARIA όπου δεν είναι. Καταστάσεις όπως expanded, selected, checked, invalid και busy εκτίθενται πάντα προγραμματιστικά, ποτέ μόνο μέσω της εμφάνισης.',
        },
        {
          title: 'Υποστήριξη πληκτρολογίου',
          body: 'Πλήρη μοτίβα πληκτρολογίου APG: μετακινούμενο tabindex, πλοήγηση με τα πλήκτρα βέλους, Home και End, Escape για απόρριψη και Enter ή Space για ενεργοποίηση, με χειρισμό των βελών που λαμβάνει υπόψη το RTL.',
        },
        {
          title: 'Διαχείριση εστίασης',
          body: 'Τα παράθυρα διαλόγου και οι επιλογείς παγιδεύουν την εστίαση όσο είναι ανοιχτά και την επιστρέφουν στο στοιχείο ενεργοποίησης κατά το κλείσιμο. Οι δείκτες εστίασης είναι πάντα ορατοί και δεν καταστέλλονται ποτέ.',
        },
        {
          title: 'Ανακοινώσεις για αναγνώστες οθόνης',
          body: 'Τα toast, οι ειδοποιήσεις, τα σφάλματα επικύρωσης και οι ασύγχρονες αλλαγές κατάστασης ανακοινώνονται μέσω ζωντανών περιοχών με το κατάλληλο επίπεδο ευγένειας.',
        },
        {
          title: 'Μειωμένη κίνηση',
          body: 'Τα εφέ κίνησης σέβονται παντού το media query prefers-reduced-motion.',
        },
        {
          title: 'Αντίθεση',
          body: 'Τα προεπιλεγμένα ανοιχτά και σκούρα θέματα πληρούν τις απαιτήσεις αντίθεσης του WCAG, και τα εργαλεία θεματοποίησης επισημαίνουν συνδυασμούς που πέφτουν κάτω από το AA.',
        },
      ],
      labelsHeading: 'Προσβάσιμα ονόματα',
      labelsBefore:
        'Τα συστατικά που αποδίδουν κείμενο επισημαίνονται μόνα τους. Οτιδήποτε αποτελείται μόνο από εικονίδιο ή είναι γραφικό εκθέτει μια είσοδο <code>aria-label</code> (με τοπικοποιημένες προεπιλογές για τα ενσωματωμένα χειριστήρια όπως τα κουμπιά εκκαθάρισης, κλεισίματος και απόρριψης), και τα πεδία φόρμας συνδέουν αυτόματα το <code>label</code>, τις υποδείξεις και τα μηνύματα σφάλματος με το χειριστήριο μέσω <code>aria-describedby</code>.',
      labelsAfter:
        'Δώστε ένα <code>label</code> ή ένα <code>aria-label</code> στα χειριστήρια χωρίς ορατό κείμενο και το συστατικό αναλαμβάνει τα υπόλοιπα: τα ονόματα, οι υποδείξεις και τα μηνύματα σφάλματος παραμένουν αυτόματα συνδεδεμένα.',
      testingHeading: 'Επαλήθευση με κάθε έκδοση',
      testingBody:
    ...
    component: {
      ...
      demos: {
        ...
        barChart: {
          ...
          software: 'Λογισμικό',
          services: 'Υπηρεσίες',
          quarters: ['Τ1', 'Τ2', 'Τ3', 'Τ4'],
        },
        lineChart: {
          visitors: 'Επισκέπτες',
          signUps: 'Εγγραφές',
          months: ['Ιαν', 'Φεβ', 'Μαρ', 'Απρ', 'Μαΐ', 'Ιουν', 'Ιουλ', 'Αυγ'],
        },
        pieChart: {
          desktop: 'Υπολογιστής',
          mobile: 'Κινητό',
      ...
      playground: {
        ...
        ariaLabelDescription:
          'Προσβάσιμο όνομα που ανακοινώνεται από τις υποστηρικτικές τεχνολογίες όταν το συστατικό δεν αποδίδει ορατή ετικέτα.',
        ...
        knobLabels: {
          'bar-chart': {
            ...
            size: 'Μέγεθος',
            animation: 'Κίνηση',
            animationDuration: 'Διάρκεια κίνησης (ms)',
            height: 'Ύψος (px)',
            stacked: 'Στοιβαγμένο',
          ...
          'line-chart': {
            ...
            animationDuration: 'Διάρκεια κίνησης (ms)',
            height: 'Ύψος (px)',
            showArea: 'Εμφάνιση περιοχής',
            showPoints: 'Εμφάνιση σημείων',
            showGrid: 'Εμφάνιση πλέγματος',
            showLegend: 'Εμφάνιση υπομνήματος',
          },
          'pie-chart': {
            ...
            height: 'Ύψος (px)',
            showLegend: 'Εμφάνιση υπομνήματος',
            showPercentages: 'Εμφάνιση ποσοστών',
          },
          timeline: {
            orientation: 'Προσανατολισμός',
            align: 'Στοίχιση',
        ...
        descriptions: {
          'bar-chart': {
            labels: 'Ετικέτες κατηγοριών κατά μήκος του άξονα κατηγοριών, μία ανά τιμή.',
            series:
              'Οι σειρές προς απεικόνιση, καθεμία με όνομα, μία τιμή ανά ετικέτα και προαιρετικό χρώμα.',
            orientation:
              'Κατεύθυνση προς την οποία εκτείνονται οι ράβδοι από τη γραμμή βάσης.',
            stacked:
              'Στοιβάζει τις σειρές κάθε ετικέτας σε μία ράβδο αντί να τις ομαδοποιεί τη μία δίπλα στην άλλη.',
            showGrid: 'Σχεδιάζει γραμμές πλέγματος σε κάθε υποδιαίρεση του άξονα τιμών.',
            showLegend:
              'Εμφανίζει υπόμνημα κάτω από το γράφημα όταν απεικονίζει περισσότερες από μία σειρές.',
            showValues:
              'Εμφανίζει την τιμή κάθε ράβδου στο άκρο της, ή το σύνολο κάθε στοίβας όταν είναι στοιβαγμένο.',
            height:
              'Ύψος της περιοχής σχεδίασης σε pixel· το πλάτος γεμίζει το κοντέινερ.',
            size: 'Οπτικό μέγεθος του κειμένου του άξονα, του υπομνήματος και του tooltip.',
            animation:
              'Κίνηση εισόδου, που επαναλαμβάνεται κάθε φορά που αλλάζουν τα δεδομένα: ανάπτυξη από τη γραμμή βάσης, διαδοχική εμφάνιση ετικέτας μετά από ετικέτα, σταδιακή εμφάνιση ή καμία.',
            animationDuration:
              'Διάρκεια της κίνησης εισόδου σε χιλιοστά του δευτερολέπτου.',
            formatValue:
              'Μορφοποιεί τις τιμές στον άξονα, στο tooltip και στον πίνακα δεδομένων· ομαδοποιημένες σύμφωνα με την ενεργή τοπική ρύθμιση από προεπιλογή.',
            pointClick:
              'Εκπέμπεται όταν γίνεται κλικ σε μια ράβδο ή όταν επιλέγεται με Enter ή Space.',
            activePointChange:
              'Εκπέμπεται όταν αλλάζει η επισημασμένη ράβδος μέσω δείκτη ή πληκτρολογίου, με null μόλις καταργηθεί η επισήμανση.',
          },
          'line-chart': {
            labels: 'Ετικέτες κατηγοριών κατά μήκος του άξονα x, μία ανά τιμή.',
            series:
              'Οι σειρές προς απεικόνιση, καθεμία με όνομα, μία τιμή ανά ετικέτα (το null αφήνει κενό) και προαιρετικό χρώμα.',
            curve: 'Πώς καμπυλώνεται η γραμμή ανάμεσα στα σημεία.',
            showArea:
              'Γεμίζει την περιοχή κάτω από κάθε γραμμή με μια ανοιχτή απόχρωση του χρώματός της.',
            showPoints: 'Σημειώνει κάθε τιμή με ένα σημείο.',
            showGrid:
              'Σχεδιάζει οριζόντιες γραμμές πλέγματος σε κάθε υποδιαίρεση του άξονα y.',
            showLegend:
              'Εμφανίζει υπόμνημα κάτω από το γράφημα όταν απεικονίζει περισσότερες από μία σειρές.',
            yMin: 'Κάτω όριο του άξονα y· προκύπτει από τα δεδομένα όταν δεν ορίζεται.',
            yMax: 'Άνω όριο του άξονα y· προκύπτει από τα δεδομένα όταν δεν ορίζεται.',
            height:
              'Ύψος της περιοχής σχεδίασης σε pixel· το πλάτος γεμίζει το κοντέινερ.',
            size: 'Οπτικό μέγεθος του κειμένου του άξονα, του υπομνήματος και του tooltip.',
            animation:
              'Κίνηση εισόδου, που επαναλαμβάνεται κάθε φορά που αλλάζουν τα δεδομένα: σχεδίαση κάθε γραμμής, αποκάλυψη από αριστερά προς τα δεξιά, σταδιακή εμφάνιση, άνοδος από τη γραμμή βάσης ή καμία.',
            animationDuration:
              'Διάρκεια της κίνησης εισόδου σε χιλιοστά του δευτερολέπτου.',
            formatValue:
              'Μορφοποιεί τις τιμές στον άξονα, στο tooltip και στον πίνακα δεδομένων· ομαδοποιημένες σύμφωνα με την ενεργή τοπική ρύθμιση από προεπιλογή.',
            pointClick:
              'Εκπέμπεται όταν γίνεται κλικ σε ένα σημείο ή όταν επιλέγεται με Enter ή Space.',
            activePointChange:
              'Εκπέμπεται όταν αλλάζει το επισημασμένο σημείο μέσω δείκτη ή πληκτρολογίου, με null μόλις καταργηθεί η επισήμανση.',
          },
          'pie-chart': {
            data: 'Τα τμήματα που σχεδιάζονται δεξιόστροφα από τη θέση των δώδεκα, καθένα με ετικέτα, τιμή και προαιρετικό χρώμα.',
            variant: 'Ένας συμπαγής κύκλος ή ένας δακτύλιος με κενό κέντρο.',
            showLegend: 'Εμφανίζει υπόμνημα με όλα τα τμήματα κάτω από το γράφημα.',
            showPercentages:
              'Προσθέτει το μερίδιο κάθε τμήματος επί του συνόλου στην καταχώρισή του στο υπόμνημα.',
            height:
              'Μέγιστη διάμετρος του γραφήματος σε pixel· συρρικνώνεται για να χωρέσει σε στενότερο κοντέινερ.',
            size: 'Οπτικό μέγεθος του κειμένου του υπομνήματος και του tooltip.',
            animation:
              'Κίνηση εισόδου, που επαναλαμβάνεται κάθε φορά που αλλάζουν τα δεδομένα: δεξιόστροφη σάρωση, ανάπτυξη από το κέντρο, σταδιακή εμφάνιση ή καμία.',
            animationDuration:
              'Διάρκεια της κίνησης εισόδου σε χιλιοστά του δευτερολέπτου.',
            formatValue:
              'Μορφοποιεί τις τιμές στο tooltip και στον πίνακα δεδομένων· ομαδοποιημένες σύμφωνα με την ενεργή τοπική ρύθμιση από προεπιλογή.',
            sliceClick:
              'Εκπέμπεται όταν γίνεται κλικ σε ένα τμήμα ή όταν επιλέγεται με Enter ή Space.',
            activeSliceChange:
              'Εκπέμπεται όταν αλλάζει το επισημασμένο τμήμα μέσω δείκτη ή πληκτρολογίου, με null μόλις καταργηθεί η επισήμανση.',
          },
          timeline: {
          ...
          toast: {
            size: 'Οπτικό μέγεθος που εφαρμόζεται σε κάθε ειδοποίηση της στοίβας.',
            position:
            ...
            show: 'Εμφανίζει μια ειδοποίηση και επιστρέφει το id της. Το μήνυμα και ο τίτλος δέχονται απλό κείμενο ή τμήματα έμφασης.',
            success: 'Εμφανίζει μια ειδοποίηση επιτυχίας και επιστρέφει το id της.',
            error: 'Εμφανίζει μια ειδοποίηση σφάλματος και επιστρέφει το id της.',
            warning: 'Εμφανίζει μια ειδοποίηση προειδοποίησης και επιστρέφει το id της.',
            info: 'Εμφανίζει μια ενημερωτική ειδοποίηση και επιστρέφει το id της.',
            dismiss: 'Αφαιρεί την ειδοποίηση με το δοσμένο id, εφόσον εμφανίζεται ακόμη.',
            clear: 'Αφαιρεί κάθε ειδοποίηση που εμφανίζεται αυτή τη στιγμή.',
            pause:
              'Αναστέλλει κάθε αντίστροφη μέτρηση αυτόματης απόκρυψης, κρατώντας τον χρόνο που απομένει σε κάθε ειδοποίηση.',
            resume: 'Συνεχίζει τις αντίστροφες μετρήσεις που ανέστειλε η pause.',
          },
          input: {
            spellcheck:
              'Τιμή για το εγγενές χαρακτηριστικό spellcheck, ενώ χωρίς ορισμό ισχύει η προεπιλογή του προγράμματος περιήγησης.',
            keepIcon:
              'Διατηρεί το αρχικό εικονίδιο ορατό όσο το πεδίο έχει τιμή. Με false το εικονίδιο εμφανίζεται μόνο μαζί με το placeholder.',
            role: 'Ρόλος ARIA που εφαρμόζεται στο εγγενές πεδίο, π.χ. combobox για typeahead.',
            ariaExpanded:
              'Κατάσταση ανάπτυξης ενός ελεγχόμενου αναδυόμενου, προωθείται ως aria-expanded.',
            ariaControls:
              'id του αναδυόμενου στοιχείου που ελέγχει το πεδίο, προωθείται ως aria-controls.',
            ariaActivedescendant:
              'id της ενεργής επιλογής στο ελεγχόμενο αναδυόμενο, προωθείται ως aria-activedescendant.',
            ariaAutocomplete:
              'Υπόδειξη συμπεριφοράς αυτόματης συμπλήρωσης, προωθείται ως aria-autocomplete.',
            labelIcon:
              'Προαιρετικό στοιχείο εικονιδίου που εμφανίζεται πριν από το κείμενο της ετικέτας.',
          ...
          'number-input': {
            allowNegative:
              'Αν επιτρέπονται αρνητικές τιμές· όταν είναι false, η τιμή περιορίζεται στο 0.',
            labelIcon:
              'Προαιρετικό στοιχείο εικονιδίου που εμφανίζεται πριν από το κείμενο της ετικέτας.',
            label: 'Ετικέτα που εμφανίζεται πάνω από το πεδίο.',
            placeholder: 'Κείμενο υποδείγματος που εμφανίζεται όταν το πεδίο είναι κενό.',
            ...
            readonly: 'Εμφανίζει το πεδίο μόνο για ανάγνωση.',
            required: 'Επισημαίνει το πεδίο ως υποχρεωτικό.',
            min: 'Ελάχιστη τιμή· οι πληκτρολογημένες τιμές περιορίζονται σε αυτήν κατά την απώλεια εστίασης.',
            max: 'Μέγιστη τιμή· οι πληκτρολογημένες τιμές περιορίζονται σε αυτήν κατά την απώλεια εστίασης.',
            step: 'Το ποσό που προσθέτει ή αφαιρεί κάθε βήμα με τα βέλη.',
            maxDigits:
              'Περιορίζει πόσους χαρακτήρες δέχεται το πεδίο και πόσο πλατύ εμφανίζεται· έξι χαρακτήρες όταν δεν οριστεί.',
            id: 'id που εφαρμόζεται στο εγγενές πεδίο και στο for της ετικέτας, δημιουργείται αυτόματα αν παραλειφθεί.',
            value:
              'Τρέχουσα τιμή του πεδίου, null όταν είναι κενό, αμφίδρομα συνδέσιμη μέσω [(value)].',
            changed: 'Εκπέμπεται με τη νέα τιμή κάθε φορά που αλλάζει.',
            focused: 'Εκπέμπεται όταν το πεδίο λαμβάνει εστίαση.',
            blurred: 'Εκπέμπεται όταν το πεδίο χάνει την εστίαση.',
            focus: 'Μεταφέρει την εστίαση πληκτρολογίου στο υποκείμενο εγγενές πεδίο.',
          },
          accordion: {
            size: 'Οπτικό μέγεθος του ακορντεόν· κάθε στοιχείο το κληρονομεί.',
          ...
          badge: {
            ...
            uppercase: 'Εμφανίζει το περιεχόμενο εξ ολοκλήρου με κεφαλαία γράμματα.',
          },
          button: {
            variant:
            ...
            uppercase: 'Εμφανίζει την ετικέτα εξ ολοκλήρου με κεφαλαία γράμματα.',
            ariaLabel:
          ...
          checkbox: {
            truncate:
              'Περικόπτει μια ετικέτα που δεν χωρά και δείχνει το πλήρες κείμενο σε επεξήγηση.',
            ariaLabel:
          ...
          'color-picker': {
            compact:
              'Εμφανίζει τον ενεργοποιητή ως απλό δείγμα χρώματος, χωρίς την τιμή και το κουμπί καθαρισμού.',
            disabled: 'Απενεργοποιεί το πεδίο.',
            errorMsg:
              'Μήνυμα σφάλματος κάτω από το πεδίο, που αντικαθιστά τη βοήθεια και επισημαίνει το πεδίο ως μη έγκυρο.',
          ...
          'eagami-wordmark': {
            variant:
              'Παραλλαγή περιεχομένου: το default είναι το σκέτο λογότυπο, το byline προσθέτει τη γραμμή σχεδίασης, το tagline προσθέτει το σύνθημα.',
            layout:
              'Διατάσσει το λογότυπο στοιβαγμένο σε γραμμές ή σε μία ενιαία γραμμή.',
            size: 'Μέγεθος γραμματοσειράς του κειμένου της μάρκας σε px· το υπόλοιπο λογότυπο κλιμακώνεται από αυτό.',
            linked:
              'Εμφανίζει το λογότυπο ως σύνδεσμο προς το eagami.com· απενεργοποιήστε το για ενσωμάτωση σε δικό σας σύνδεσμο ή στατικό πλαίσιο.',
          },
          'empty-state': {
          ...
          paginator: {
            ...
            showAllOption:
              'Προσφέρει μετά τις επιλογές το μέγεθος σελίδας «Όλα», εκπέμποντας κατά την επιλογή PAGE_SIZE_ALL ως μέγεθος σελίδας.',
            pageSizeLabel:
              'Τι μετρά ο επιλογέας μεγέθους σελίδας: τη μεταφρασμένη ετικέτα «Γραμμές», «Στοιχεία», «Αποτελέσματα», «Προϊόντα», «Εγγραφές», «Καταχωρήσεις», «Αναρτήσεις» ή «Άρθρα» ανά σελίδα.',
          },
          'progress-bar': {
          ...
          slider: {
            ...
            snapValues:
              'Τιμές στις οποίες προσκολλάται η λαβή κατά το σύρσιμο· καθεμία σχεδιάζεται ως σημάδι στη ράγα.',
          ...
          tag: {
            color:
              'Χρώμα γεμίσματος σε δεκαεξαδική μορφή, που βάφει την ετικέτα και επιλέγει ευανάγνωστο χρώμα κειμένου.',
            variant: 'Σημασιολογικό χρωματικό σχήμα της ετικέτας.',
            size: 'Οπτικό μέγεθος της ετικέτας.',
            maxWidth:
              'Μέγιστο πλάτος της ετικέτας σε px· μια μεγαλύτερη ετικέτα περικόπτεται. Ορίζεται και ως --ea-tag-max-width.',
            tooltip:
              'Πού δείχνει το πλήρες κείμενό της μια ετικέτα περικομμένη από το maxWidth: πάνω ή κάτω από το tag, ή none για απόκρυψη.',
            removable:
            ...
            removeTabbable:
              'Αν το κουμπί αφαίρεσης αποτελεί στάση του Tab· ορίστε το σε false μέσα σε σύνθετο στοιχείο ελέγχου που διαχειρίζεται το ίδιο την πλοήγηση με πληκτρολόγιο.',
            removed:
          ...
          textarea: {
            ...
            minHeight: 'Ελάχιστο ύψος σε px· ποτέ μικρότερο από το προεπιλεγμένο ύψος.',
          ...
          tooltip: {
            tooltipOpen:
              'Εμφανίζει ή κρύβει τη φούσκα προγραμματιστικά, για ενεργοποιητή που δεν δέχεται ο ίδιος δείκτη ή εστίαση· το null το αφήνει στον δείκτη και την εστίαση.',
            whenClipped:
              'Δείχνει τη φούσκα μόνο όσο ο ενεργοποιητής κόβει το περιεχόμενό του.',
            flip: 'Μετακινεί τη φούσκα στην αντίθετη πλευρά όταν δεν υπάρχει χώρος στη ζητούμενη.',
            maxWidth:
              'Μέγιστο πλάτος σε pixel· το κείμενο αναδιπλώνεται σε αυτό το πλάτος (ελάχιστο 50px). Η υπόδειξη δεν ξεπερνά ποτέ το παράθυρο προβολής.',
            dismissDelay:
              'Καθυστέρηση σε χιλιοστά του δευτερολέπτου πριν αποκρυφτεί μια κυλιόμενη υπόδειξη αφού φύγει ο δείκτης, αρκετή για να μετακινηθεί κανείς πάνω της. Οι υποδείξεις που χωρούν αποκρύπτονται αμέσως.',
            eaTooltip:
              'Περιεχόμενο της υπόδειξης που εμφανίζεται κατά την αιώρηση και την εστίαση πληκτρολογίου. Δέχεται απλό κείμενο ή TemplateRef για μορφοποιημένο περιεχόμενο.',
          ...
          autocomplete: {
            ...
            options:
              'Πλήρης λίστα επιλογών διαθέσιμων για φιλτράρισμα και επιλογή, επίπεδη ή χωρισμένη σε ομάδες.',
            placeholder: 'Κείμενο υποδείγματος που εμφανίζεται όταν το πεδίο είναι κενό.',
            readonly: 'Εμφανίζει το πεδίο μόνο για ανάγνωση.',
            required: 'Επισημαίνει το πεδίο ως υποχρεωτικό.',
            size: 'Οπτικό μέγεθος του πεδίου.',
          ...
          'command-palette': {
            disabledWhen:
              'Προαιρετικό κατηγόρημα που απενεργοποιεί κάθε στοιχείο για το οποίο επιστρέφει true, επιπλέον της σημαίας disabled κάθε στοιχείου.',
            emptyMessage:
          ...
          'date-picker': {
            ...
            hint: 'Βοηθητικό κείμενο κάτω από το πεδίο, κρυμμένο όταν υπάρχει σφάλμα.',
            id: 'id που εφαρμόζεται στο πεδίο και στο for της ετικέτας, δημιουργείται αυτόματα αν παραλειφθεί.',
            labelIcon:
              'Προαιρετικό στοιχείο εικονιδίου που εμφανίζεται πριν από το κείμενο της ετικέτας.',
            label: 'Ετικέτα που εμφανίζεται πάνω από το πεδίο.',
            locale:
            ...
            placeholder:
              'Κείμενο υποδείγματος στο πεδίο όταν δεν έχει επιλεγεί ημερομηνία.',
            readonly:
              'Εμφανίζει το πεδίο μόνο για ανάγνωση, εμποδίζοντας το άνοιγμα του ημερολογίου.',
            required: 'Επισημαίνει το πεδίο ως υποχρεωτικό.',
            size: 'Οπτικό μέγεθος του πεδίου του επιλογέα ημερομηνίας.',
            ...
            focus: 'Μεταφέρει την εστίαση πληκτρολογίου στο πεδίο ημερομηνίας.',
            onPopoverCloseRequested:
          ...
          menu: {
            size: 'Οπτικό μέγεθος του μενού· κάθε στοιχείο το κληρονομεί.',
            maxHeight:
              'Μέγιστο ύψος της κυλιόμενης λίστας ως μήκος CSS· τα ψηλότερα μενού κυλούν πέρα από αυτό.',
            ariaLabel:
          ...
          'multi-select': {
            created:
              'Εκπέμπεται με το κείμενο που πληκτρολογήθηκε όταν επιλεγεί η γραμμή δημιουργίας.',
            allowCreate:
              'Προσφέρει μια γραμμή δημιουργίας όταν το κείμενο αναζήτησης δεν ταιριάζει σε καμία επιλογή.',
            ...
            maxChipWidth:
              'Μέγιστο πλάτος ενός chip επιλογής σε px· μεγαλύτερη ετικέτα περικόπτεται και δείχνει το πλήρες κείμενό της σε tooltip.',
            popoverMaxHeight:
              'Μέγιστο ύψος του popover επιλογών σε px πριν αρχίσει να κυλά η λίστα.',
            popoverMaxWidth:
              'Μέγιστο πλάτος του popover επιλογών σε px, ή anchor για να κρατηθεί στο πλάτος του πεδίου.',
            options:
              'Λίστα επιλέξιμων επιλογών που αποδίδονται στην αναπτυσσόμενη λίστα, επίπεδη ή χωρισμένη σε ομάδες.',
            placeholder:
          ...
          'file-uploader': {
            ...
            dragOverChanged:
              'Ενεργοποιείται όταν μια μεταφορά μπαίνει ή βγαίνει από τη ζώνη απόθεσης, για wrapper που κρατά δικό του στυλ μεταφοράς.',
            rejected:
          ...
          'form-field': {
            size: 'Οπτικό μέγεθος του πεδίου· η ετικέτα, το κείμενο του στοιχείου ελέγχου, οι αποστάσεις και τα μηνύματα κλιμακώνονται μαζί του.',
            errorMsg:
              'Μήνυμα σφάλματος κάτω από το στοιχείο ελέγχου, που αντικαθιστά τη βοήθεια και επισημαίνει το πεδίο ως μη έγκυρο.',
            hint: 'Βοηθητικό κείμενο κάτω από το στοιχείο ελέγχου, κρυμμένο όταν υπάρχει σφάλμα.',
            id: 'Βάση id για τη σύνδεση ετικέτας και μηνύματος, δημιουργείται αυτόματα αν παραλειφθεί.',
            labelIcon:
              'Προαιρετικό στοιχείο εικονιδίου που εμφανίζεται πριν από το κείμενο της ετικέτας.',
            label: 'Ετικέτα που εμφανίζεται πάνω από το στοιχείο ελέγχου.',
            required: 'Επισημαίνει το πεδίο ως υποχρεωτικό.',
          },
          popover: {
            anchor:
            ...
            ariaLabelledby:
              'Id του στοιχείου που επισημαίνει την επιφάνεια του popover, προωθείται ως aria-labelledby.',
            clamp:
            ...
            maxWidth:
              'Μέγιστο πλάτος της επιφάνειας σε px, ή anchor για περιορισμό στο πλάτος του στοιχείου αγκύρωσης.',
            ...
            trapFocus:
              'Διατηρεί τα Tab και Shift+Tab σε κυκλική κίνηση μέσα στην επιφάνεια όσο είναι ανοιχτό, για popover τύπου διαλόγου.',
            closeRequested:
          ...
          breadcrumbs: {
            size: 'Οπτικό μέγεθος της διαδρομής breadcrumb.',
            ariaLabel:
          ...
          drawer: {
            animation:
              'Κινούμενη ολίσθηση καθώς το συρτάρι ανοίγει και κλείνει: none (στιγμιαία), linear (σταθερή ταχύτητα) ή eased (καμπύλη ομαλής επιβράδυνσης).',
            ariaLabel:
            ...
            mode: 'Πώς σχετίζεται το συρτάρι με τη σελίδα: το overlay επιπλέει πάνω από μια σκοτεινιασμένη σελίδα με παγιδευμένη εστίαση, ενώ το push ανοίγει μη τροπικά και αναδιατάσσει το περιεχόμενο της σελίδας στο πλάι.',
            ...
            pushTarget:
              'Στοιχείο του οποίου το περιεχόμενο ωθείται στο πλάι σε λειτουργία push, ως επιλογέας CSS ή αναφορά στοιχείου, με προεπιλογή το body του εγγράφου.',
            showClose: 'Εμφανίζει το κουμπί κλεισίματος στην κεφαλίδα του συρταριού.',
            size: 'Έκταση του πίνακα του συρταριού κατά τον κύριο άξονά του: πλάτος για τα πλευρικά συρτάρια, ύψος για τα πάνω και κάτω συρτάρια.',
            closed:
              'Εκπέμπεται όταν το συρτάρι κλείνει, είτε μέσω του κουμπιού, του υποβάθρου, είτε με Escape.',
            opened: 'Εκπέμπεται μόλις το συρτάρι εμφανιστεί.',
          },
          'data-table': {
            nowrap:
              'Κρατά κάθε κελί σε μία γραμμή, ώστε μια στενή οθόνη να κυλά τον πίνακα πλάγια αντί να αναδιπλώνει το κείμενό του.',
            rowHref:
              'Δίνει σε κάθε γραμμή έναν προορισμό συνδέσμου, ως πραγματικό σύνδεσμο σε κάθε κελί ώστε το πρόγραμμα περιήγησης να τον εμφανίζει και να μπορεί να τον ανοίξει, ενώ ένα απλό κλικ εξακολουθεί να εκπέμπει rowActivate. Μια γραμμή για την οποία επιστρέφει null μένει αδρανής, χωρίς σύνδεσμο, επισήμανση στο πέρασμα του δείκτη, εστίαση ή ενεργοποίηση.',
            sizingRows:
              'Γραμμές με το πλατύτερο περιεχόμενο κάθε στήλης, που διατάσσονται αλλά δεν εμφανίζονται ποτέ, ώστε τα πλάτη των στηλών να μένουν σταθερά μεταξύ σελίδων και κατά τη φόρτωση δεδομένων.',
            size: 'Οπτικό μέγεθος του πίνακα· οι εσοχές πυκνότητας και τα εικονίδια κλιμακώνονται μαζί του.',
            clickable:
              'Επισημαίνει τις γραμμές δεδομένων ως επιλέξιμες: εμφανίζει δείκτη και ενεργοποιεί το rowActivate με κλικ ή Enter/Space.',
            rowActivate:
              'Ενεργοποιείται με τα δεδομένα της γραμμής όταν μια επιλέξιμη γραμμή ενεργοποιηθεί με κλικ ή πληκτρολόγιο.',
            navigable:
              'Μετατρέπει τον πίνακα σε πλέγμα με πλοήγηση μέσω πληκτρολογίου, με μετακινούμενη εστίαση και μετακίνηση στα κελιά με τα βέλη.',
            bordered: 'Αποδίδει περίγραμμα γύρω από κάθε κελί.',
            caption:
              'Ορατή λεζάντα που αποδίδεται πάνω από τον πίνακα· τον ονοματίζει επίσης για τις υποστηρικτικές τεχνολογίες.',
            columns:
          ...
          stepper: {
            ...
            orientation:
              'Ο άξονας στον οποίο τοποθετούνται τα βήματα· στοιβάξτε τα κατακόρυφα όπου δεν χωρά μια σειρά.',
          ...
          'field-label': {
            ...
            icon: 'Προαιρετικό στοιχείο εικονιδίου που εμφανίζεται πριν από το κείμενο της ετικέτας.',
            labelId:
          ...
          dialog: {
            closeRequested:
              'Εκπέμπεται με manualClose σε κάθε αίτημα κλεισίματος, χωρίς να κλείνει ο διάλογος.',
            manualClose:
              'Αναφέρει κάθε κλείσιμο μέσω closeRequested και αφήνει τον διάλογο ανοιχτό μέχρι το open να γίνει false.',
            modal:
              'Εμφανίζει τον διάλογο ως modal με φόντο επικάλυψης· με false αιωρείται μη modal και η σελίδα από πίσω παραμένει κυλιόμενη και διαδραστική.',
            closeDisabled:
              'Απενεργοποιεί το ενσωματωμένο κουμπί κλεισίματος, για παράδειγμα όσο γίνεται αποθήκευση.',
            ariaLabel:
