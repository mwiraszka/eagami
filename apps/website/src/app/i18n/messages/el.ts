...
export const el: WebMessages = {
  ...
  ui: {
    ...
    icons: {
      ...
      title: 'Εικονίδια',
      lede: 'Αυτόνομα συστατικά Angular που κληρονομούν το χρώμα τους και προσαρμόζονται στο <code>font-size</code>, ώστε να αποδίδονται σε οποιοδήποτε μέγεθος. Τα εικονίδια που προέρχονται από το Feather εκθέτουν επίσης μια είσοδο <code>[strokeWidth]</code> (προεπιλογή 2) για λεπτότερες ή παχύτερες γραμμές. Τα περισσότερα προέρχονται από τα <a href="https://feathericons.com/" target="_blank" rel="noopener noreferrer"><span>Feather Icons</span></a> του <a href="https://github.com/colebemis" target="_blank" rel="noopener noreferrer"><span>Cole Bemis</span></a> υπό την <a href="https://github.com/feathericons/feather/blob/master/LICENSE" target="_blank" rel="noopener noreferrer"><span>άδεια MIT</span></a>· τα υπόλοιπα είναι πρωτότυπα εικονίδια του Eagami UI. Κάντε κλικ σε ένα εικονίδιο για να αντιγράψετε τον επιλογέα του.',
    ...
    component: {
      ...
      demos: {
        ...
        autocomplete: {
          ...
          errorText: 'Παρακαλώ επιλέξτε ένα framework',
        ...
        fileUploader: {
          ...
          withErrorLabel: 'Μεταφόρτωση εικόνων',
        ...
        rating: {
          ...
          withErrorLabel: 'Πώς ήταν η εμπειρία σας;',
