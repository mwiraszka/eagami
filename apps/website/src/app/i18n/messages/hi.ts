  ...
  ui: {
    ...
    index: {
      ...
      principles: [
        ...
        {
          title: 'स्थानीयकृत',
          body: 'अंतर्निहित कंपोनेंट टेक्स्ट 15 भाषाओं में शिप होता है।',
        },
        {
          title: 'आधुनिक',
    ...
    component: {
      ...
      playground: {
        ...
        descriptions: {
          ...
          drawer: {
            animated: 'ड्रॉअर खुलने पर पैनल को उसके किनारे से अंदर सरकाता है।',
            ariaLabel:
            ...
            width: 'अपनी प्राथमिक अक्ष के साथ ड्रॉअर पैनल की चौड़ाई।',
            closed:
              'जब ड्रॉअर बंद होता है तो ट्रिगर होता है, चाहे बंद बटन, बैकड्रॉप या Escape के माध्यम से हो।',
            opened: 'showModal() के माध्यम से ड्रॉअर दिखने के बाद ट्रिगर होता है।',
          },
          'data-table': {
            clickable:
