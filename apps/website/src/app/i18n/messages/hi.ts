    ...
    component: {
      ...
      demos: {
        ...
        lineChart: {
          visitors: 'विज़िटर',
          signUps: 'पंजीकरण',
          months: ['जन॰', 'फ़र॰', 'मार्च', 'अप्रैल', 'मई', 'जून', 'जुल॰', 'अग॰'],
        },
        pieChart: {
          desktop: 'डेस्कटॉप',
          mobile: 'मोबाइल',
      ...
      playground: {
        ...
        descriptions: {
          'bar-chart': {
            labels: 'श्रेणी अक्ष के साथ श्रेणी लेबल, प्रत्येक मान के लिए एक।',
            series:
              'प्लॉट की जाने वाली सीरीज़, प्रत्येक में एक नाम, प्रति लेबल एक मान और एक वैकल्पिक रंग।',
            orientation: 'वह दिशा जिसमें बार आधार रेखा से फैलते हैं।',
            stacked:
              'प्रत्येक लेबल की सीरीज़ को साथ-साथ समूहित करने के बजाय एक बार में स्टैक करता है।',
            showGrid: 'मान अक्ष के प्रत्येक टिक पर ग्रिड रेखाएं खींचता है।',
            showLegend:
              'जब चार्ट एक से अधिक सीरीज़ प्लॉट करता है तो उसके नीचे एक लीजेंड दिखाता है।',
            showValues:
              'प्रत्येक बार का मान उसके सिरे पर दिखाता है, या स्टैक्ड होने पर प्रत्येक स्टैक का कुल योग।',
            height: 'प्लॉट की ऊंचाई पिक्सेल में; चौड़ाई कंटेनर को भरती है।',
            size: 'अक्ष, लीजेंड और टूलटिप टेक्स्ट का दृश्य आकार।',
            animation:
              'प्रवेश एनिमेशन, जो हर बार डेटा बदलने पर फिर से चलता है: आधार रेखा से बढ़ना, एक के बाद एक लेबल का क्रमिक प्रकट होना, फ़ेड इन, या कोई नहीं।',
            animationDuration: 'प्रवेश एनिमेशन की अवधि मिलीसेकंड में।',
            formatValue:
              'अक्ष, टूलटिप और डेटा तालिका में मानों को फ़ॉर्मेट करता है; डिफ़ॉल्ट रूप से सक्रिय लोकेल के अनुसार समूहित।',
            pointClick:
              'जब किसी बार पर क्लिक किया जाता है, या Enter या Space से चुना जाता है तो ट्रिगर होता है।',
            activePointChange:
              'जब पॉइंटर या कीबोर्ड से हाइलाइट किया गया बार बदलता है तो ट्रिगर होता है, हाइलाइट हटने पर null के साथ।',
          },
          'line-chart': {
            labels: 'x-अक्ष के साथ श्रेणी लेबल, प्रत्येक मान के लिए एक।',
            series:
              'प्लॉट की जाने वाली सीरीज़, प्रत्येक में एक नाम, प्रति लेबल एक मान (null एक अंतराल छोड़ता है) और एक वैकल्पिक रंग।',
            curve: 'बिंदुओं के बीच रेखा कैसे मुड़ती है।',
            showArea:
              'प्रत्येक रेखा के नीचे के क्षेत्र को उसके रंग की हल्की छटा से भरता है।',
            showPoints: 'प्रत्येक मान को एक बिंदु से चिह्नित करता है।',
            showGrid: 'y-अक्ष के प्रत्येक टिक पर क्षैतिज ग्रिड रेखाएं खींचता है।',
            showLegend:
              'जब चार्ट एक से अधिक सीरीज़ प्लॉट करता है तो उसके नीचे एक लीजेंड दिखाता है।',
            yMin: 'y-अक्ष की निचली सीमा; सेट न होने पर डेटा से निकाली जाती है।',
            yMax: 'y-अक्ष की ऊपरी सीमा; सेट न होने पर डेटा से निकाली जाती है।',
            height: 'प्लॉट की ऊंचाई पिक्सेल में; चौड़ाई कंटेनर को भरती है।',
            size: 'अक्ष, लीजेंड और टूलटिप टेक्स्ट का दृश्य आकार।',
            animation:
              'प्रवेश एनिमेशन, जो हर बार डेटा बदलने पर फिर से चलता है: प्रत्येक रेखा खींचना, बाएँ से दाएँ प्रकट करना, फ़ेड इन, आधार रेखा से ऊपर उठना, या कोई नहीं।',
            animationDuration: 'प्रवेश एनिमेशन की अवधि मिलीसेकंड में।',
            formatValue:
              'अक्ष, टूलटिप और डेटा तालिका में मानों को फ़ॉर्मेट करता है; डिफ़ॉल्ट रूप से सक्रिय लोकेल के अनुसार समूहित।',
            pointClick:
              'जब किसी बिंदु पर क्लिक किया जाता है, या Enter या Space से चुना जाता है तो ट्रिगर होता है।',
            activePointChange:
              'जब पॉइंटर या कीबोर्ड से हाइलाइट किया गया बिंदु बदलता है तो ट्रिगर होता है, हाइलाइट हटने पर null के साथ।',
          },
          'pie-chart': {
            data: 'बारह बजे की स्थिति से दक्षिणावर्त खींचे जाने वाले स्लाइस, प्रत्येक में एक लेबल, एक मान और एक वैकल्पिक रंग।',
            variant: 'एक ठोस पाई, या खाली केंद्र वाली एक रिंग।',
            showLegend: 'चार्ट के नीचे सभी स्लाइस का एक लीजेंड दिखाता है।',
            showPercentages:
              'प्रत्येक स्लाइस की लीजेंड प्रविष्टि में कुल में उसका हिस्सा जोड़ता है।',
            height:
              'चार्ट का सबसे बड़ा व्यास पिक्सेल में; संकरे कंटेनर में फ़िट होने के लिए यह सिकुड़ जाता है।',
            size: 'लीजेंड और टूलटिप टेक्स्ट का दृश्य आकार।',
            animation:
              'प्रवेश एनिमेशन, जो हर बार डेटा बदलने पर फिर से चलता है: दक्षिणावर्त स्वीप, केंद्र से बढ़ना, फ़ेड इन, या कोई नहीं।',
            animationDuration: 'प्रवेश एनिमेशन की अवधि मिलीसेकंड में।',
            formatValue:
              'टूलटिप और डेटा तालिका में मानों को फ़ॉर्मेट करता है; डिफ़ॉल्ट रूप से सक्रिय लोकेल के अनुसार समूहित।',
            sliceClick:
              'जब किसी स्लाइस पर क्लिक किया जाता है, या Enter या Space से चुना जाता है तो ट्रिगर होता है।',
            activeSliceChange:
              'जब पॉइंटर या कीबोर्ड से हाइलाइट किया गया स्लाइस बदलता है तो ट्रिगर होता है, हाइलाइट हटने पर null के साथ।',
          },
          timeline: {
          ...
          toast: {
            size: 'स्टैक के प्रत्येक टोस्ट पर लागू दृश्य आकार।',
            position: 'व्यूपोर्ट का कोना या किनारा जिससे टोस्ट स्टैक पिन किया गया है।',
            clearable: 'प्रत्येक टोस्ट पर एक खारिज बटन दिखाएं।',
            show: 'एक टोस्ट दिखाता है और उसकी id लौटाता है। इसका संदेश और शीर्षक सादा स्ट्रिंग या ज़ोर वाले खंड लेते हैं।',
            success: 'सफलता टोस्ट दिखाता है और उसकी id लौटाता है।',
            error: 'त्रुटि टोस्ट दिखाता है और उसकी id लौटाता है।',
            warning: 'चेतावनी टोस्ट दिखाता है और उसकी id लौटाता है।',
            info: 'सूचना टोस्ट दिखाता है और उसकी id लौटाता है।',
            dismiss: 'दी गई id वाला टोस्ट हटाता है, यदि वह अब भी दिख रहा हो।',
            clear: 'इस समय दिख रहे सभी टोस्ट हटाता है।',
            pause:
              'स्वतः बंद होने की सभी उलटी गिनतियाँ रोकता है और हर टोस्ट का बचा समय बनाए रखता है।',
            resume: 'pause द्वारा रोकी गई उलटी गिनतियाँ फिर से शुरू करता है।',
          },
          input: {
            spellcheck:
              'नेटिव spellcheck विशेषता का मान, सेट न होने पर ब्राउज़र का डिफ़ॉल्ट लागू रहता है।',
            keepIcon:
            ...
            labelIcon: 'वैकल्पिक आइकन कॉम्पोनेंट जो लेबल टेक्स्ट से पहले दिखाया जाता है।',
          ...
          'number-input': {
            ...
            readonly: 'फ़ील्ड को केवल-पढ़ने योग्य रेंडर करता है।',
            required: 'फ़ील्ड को आवश्यक के रूप में चिह्नित करता है।',
            min: 'न्यूनतम मान; टाइप किए गए मान फ़ोकस हटने पर इस तक सीमित कर दिए जाते हैं।',
            max: 'अधिकतम मान; टाइप किए गए मान फ़ोकस हटने पर इस तक सीमित कर दिए जाते हैं।',
            step: 'तीर कुंजियों से हर चरण में जुड़ने या घटने वाली मात्रा।',
            maxDigits:
              'सीमित करता है कि फ़ील्ड कितने वर्ण स्वीकार करता है और वह कितना चौड़ा दिखता है; निर्दिष्ट न होने पर छह वर्ण।',
            id: 'नेटिव इनपुट और लेबल for पर लागू id, छोड़े जाने पर स्वतः-उत्पन्न।',
            value:
          ...
          accordion: {
            size: 'अकॉर्डियन का दृश्य आकार; प्रत्येक आइटम इसे इनहेरिट करता है।',
          ...
          badge: {
            ...
            uppercase: 'सामग्री को पूरी तरह अपरकेस अक्षरों में दिखाता है।',
          },
          button: {
            ...
            uppercase: 'लेबल को पूरी तरह अपरकेस अक्षरों में दिखाता है।',
            ariaLabel:
          ...
          checkbox: {
            truncate:
              'कॉलम के लिए बहुत लंबे लेबल को छोटा करता है और पूरा पाठ टूलटिप में दिखाता है।',
          ...
          'color-picker': {
            compact:
              'ट्रिगर को सिर्फ़ रंग के नमूने के रूप में दिखाता है, मान और क्लियर बटन के बिना।',
            disabled: 'फ़ील्ड को अक्षम करता है।',
            errorMsg:
              'फ़ील्ड के नीचे दिखाया गया त्रुटि संदेश, संकेत को बदलता है और फ़ील्ड को अमान्य चिह्नित करता है।',
          ...
          'eagami-wordmark': {
            variant:
              'सामग्री वेरिएंट: default नंगा वर्डमार्क है, byline designed-by लाइन जोड़ता है, tagline टैगलाइन जोड़ता है।',
            layout:
              'वर्डमार्क को कई पंक्तियों में स्टैक करता है या एक अकेली पंक्ति पर इनलाइन करता है।',
            size: 'ब्रांड टेक्स्ट का फ़ॉन्ट आकार px में; बाकी वर्डमार्क इसी से स्केल होता है।',
            linked:
              'वर्डमार्क को eagami.com के लिंक के रूप में दिखाता है; कस्टम लिंक या स्थिर संदर्भ में एम्बेड करने के लिए बंद करें।',
          },
          'empty-state': {
          ...
          paginator: {
            ...
            showAllOption:
              'विकल्पों के बाद «सभी» पृष्ठ आकार देता है, और चुने जाने पर पृष्ठ आकार के रूप में PAGE_SIZE_ALL भेजता है।',
            pageSizeLabel:
              'पृष्ठ आकार चयनकर्ता क्या गिनता है: प्रति पृष्ठ «पंक्तियाँ», «आइटम», «परिणाम», «उत्पाद», «रिकॉर्ड», «प्रविष्टियाँ», «पोस्ट» या «लेख» का अनूदित लेबल।',
          },
          'progress-bar': {
          ...
          slider: {
            ...
            snapValues:
              'वे मान जिन पर खींचते समय थंब चिपक जाता है; प्रत्येक ट्रैक पर एक निशान के रूप में दिखता है।',
          ...
          tag: {
            color:
              'हेक्स मान में भरण रंग, जो टैग को रंगता है और पढ़ने योग्य पाठ रंग चुनता है।',
            variant: 'टैग की सिमेंटिक रंग योजना।',
            size: 'टैग का दृश्य आकार।',
            maxWidth:
              'टैग की अधिकतम चौड़ाई px में; लंबा लेबल छोटा कर दिया जाता है। --ea-tag-max-width के रूप में भी सेट किया जा सकता है।',
            tooltip:
              'maxWidth से कटी लेबल अपना पूरा टेक्स्ट कहाँ दिखाती है: टैग के ऊपर या नीचे, या छिपाने के लिए none।',
            removable:
            ...
            removeTabbable:
              'क्या हटाएं बटन एक टैब स्टॉप है; कीबोर्ड नेविगेशन स्वयं संभालने वाले संयुक्त विजेट के अंदर इसे false सेट करें।',
            removed:
          ...
          tooltip: {
            tooltipOpen:
              'बुलबुले को प्रोग्राम से दिखाता या छिपाता है, ऐसे ट्रिगर के लिए जिस पर स्वयं होवर या फ़ोकस नहीं होता; null इसे होवर और फ़ोकस पर छोड़ता है।',
            whenClipped: 'बुलबुला केवल तब दिखाता है जब ट्रिगर अपनी सामग्री काट रहा हो।',
          ...
          autocomplete: {
            ...
            options:
              'फ़िल्टरिंग और चयन के लिए उपलब्ध विकल्पों की पूरी सूची, सपाट या समूहों में विभाजित।',
            placeholder: 'फ़ील्ड खाली होने पर दिखाया गया प्लेसहोल्डर।',
            readonly: 'फ़ील्ड को केवल-पढ़ने योग्य रेंडर करता है।',
            required: 'फ़ील्ड को आवश्यक के रूप में चिह्नित करता है।',
            size: 'फ़ील्ड का दृश्य आकार।',
          ...
          'date-picker': {
            ...
            hint: 'फ़ील्ड के नीचे दिखाया गया सहायक टेक्स्ट, त्रुटि दिखने पर छिपा रहता है।',
            id: 'फ़ील्ड और लेबल for पर लागू id, छोड़े जाने पर स्वतः-उत्पन्न।',
            labelIcon: 'वैकल्पिक आइकन कॉम्पोनेंट जो लेबल टेक्स्ट से पहले दिखाया जाता है।',
            label: 'फ़ील्ड के ऊपर रेंडर किया गया टेक्स्ट लेबल।',
            locale:
            ...
            placeholder:
              'जब कोई तारीख चयनित नहीं होती तो फ़ील्ड में दिखाया गया प्लेसहोल्डर।',
            readonly:
              'फ़ील्ड को केवल-पढ़ने योग्य रेंडर करता है, कैलेंडर को खुलने से रोकता है।',
            required: 'फ़ील्ड को आवश्यक के रूप में चिह्नित करता है।',
            size: 'डेट पिकर फ़ील्ड का दृश्य आकार।',
            value:
            ...
            focus: 'तारीख फ़ील्ड पर कीबोर्ड फ़ोकस ले जाता है।',
            onPopoverCloseRequested:
          ...
          menu: {
            size: 'मेनू का दृश्य आकार; प्रत्येक आइटम इसे इनहेरिट करता है।',
            maxHeight:
          ...
          'multi-select': {
            created: 'बनाने की पंक्ति चुनने पर टाइप किए गए पाठ के साथ चलता है।',
            allowCreate:
              'जब खोज पाठ किसी विकल्प से मेल नहीं खाता तो बनाने की पंक्ति दिखाता है।',
            ...
            maxChipWidth:
              'चयनित मान चिप की अधिकतम चौड़ाई px में; लंबा लेबल छोटा होकर अपना पूरा टेक्स्ट टूलटिप में दिखाता है।',
            popoverMaxHeight:
              'विकल्प पॉपओवर की अधिकतम ऊँचाई px में, जिसके बाद सूची स्क्रॉल होती है।',
            popoverMaxWidth:
              'विकल्प पॉपओवर की अधिकतम चौड़ाई px में, या फ़ील्ड की चौड़ाई तक सीमित रखने के लिए anchor।',
            options:
              'ड्रॉपडाउन सूची में रेंडर किए गए चयन योग्य विकल्पों की सूची, सपाट या समूहों में विभाजित।',
            placeholder:
          ...
          'file-uploader': {
            ...
            dragOverChanged:
              'तब चलता है जब कोई ड्रैग ड्रॉपज़ोन में आता या उससे बाहर जाता है, अपनी ड्रैग स्टाइलिंग रखने वाले रैपर के लिए।',
            rejected:
          ...
          'form-field': {
            size: 'फ़ील्ड का दृश्य आकार; लेबल, कंट्रोल टेक्स्ट, स्पेसिंग और संदेश इसके साथ स्केल होते हैं।',
            errorMsg:
          ...
          popover: {
            ...
            maxWidth:
              'सतह की अधिकतम चौड़ाई px में, या एंकर तत्व की चौड़ाई तक सीमित रखने के लिए anchor।',
          ...
          breadcrumbs: {
            size: 'ब्रेडक्रंब ट्रेल का दृश्य आकार।',
            ariaLabel:
          ...
          'data-table': {
            nowrap:
              'हर सेल को एक ही पंक्ति में रखता है, ताकि संकरा व्यूपोर्ट टेक्स्ट लपेटने के बजाय तालिका को बगल में स्क्रॉल करे।',
            rowHref:
              'हर पंक्ति को एक लिंक लक्ष्य देता है, जो हर सेल में असली लिंक के रूप में रहता है ताकि ब्राउज़र उसे दिखा और खोल सके, जबकि सामान्य क्लिक अब भी rowActivate चलाता है। जिस पंक्ति के लिए यह null लौटाता है वह निष्क्रिय रहती है, बिना लिंक, होवर हाइलाइट, फ़ोकस या सक्रियण के।',
            sizingRows:
              'हर कॉलम की सबसे चौड़ी सामग्री वाली पंक्तियाँ, जो लेआउट में शामिल होती हैं पर कभी दिखाई नहीं जातीं, ताकि पृष्ठों के बीच और डेटा लोड होते समय कॉलम की चौड़ाई स्थिर रहे।',
            size: 'टेबल का दृश्य आकार; घनत्व पैडिंग और आइकन इसके साथ स्केल होते हैं।',
            clickable:
            ...
            caption:
              'तालिका के ऊपर प्रदर्शित दृश्य कैप्शन; यह सहायक तकनीक के लिए उसे नाम भी देता है।',
            columns:
          ...
          'field-label': {
            ...
            icon: 'वैकल्पिक आइकन कॉम्पोनेंट जो लेबल टेक्स्ट से पहले दिखाया जाता है।',
            labelId:
          ...
          dialog: {
            closeRequested:
              'manualClose के साथ हर बंद करने के अनुरोध पर चलता है, डायलॉग बंद किए बिना।',
            manualClose:
              'हर बंद होने की सूचना closeRequested से देता है और open के false होने तक डायलॉग खुला रखता है।',
            modal:
              'डायलॉग को बैकड्रॉप के साथ मोडल रूप में दिखाता है; false होने पर यह नॉन-मोडल रूप से तैरता है और पीछे का पेज स्क्रॉल करने योग्य और इंटरैक्टिव बना रहता है।',
            closeDisabled:
              'अंतर्निहित बंद करने वाले बटन को निष्क्रिय करता है, जैसे सहेजने के दौरान।',
            ariaLabel:
