...
export const pl: WebMessages = {
  ...
  ui: {
    ...
    icons: {
      ...
      title: 'Ikony',
      lede: 'Samodzielne komponenty Angular, które dziedziczą kolor i skalują się wraz z <code>font-size</code>, dzięki czemu renderują się w dowolnym rozmiarze. Ikony pochodzące z Feather udostępniają również wejście <code>[strokeWidth]</code> (domyślnie 2) dla cieńszych lub grubszych linii. Większość pochodzi z <a href="https://feathericons.com/" target="_blank" rel="noopener noreferrer"><span>Feather Icons</span></a> autorstwa <a href="https://github.com/colebemis" target="_blank" rel="noopener noreferrer"><span>Cole’a Bemisa</span></a> i używana jest na <a href="https://github.com/feathericons/feather/blob/master/LICENSE" target="_blank" rel="noopener noreferrer"><span>licencji MIT</span></a>; pozostałe to oryginalne ikony Eagami UI. Kliknij ikonę, aby skopiować jej selektor.',
