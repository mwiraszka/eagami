...
export const pl: WebMessages = {
  ...
  home: {
    ...
    contact: {
      ...
      errorMessage:
        'Niestety coś poszło nie tak. Proszę o wysłanie e-maila bezpośrednio na info@eagami.com.',
    },
  },
  privacy: {
      ...
      playground: {
        ...
        descriptions: {
          ...
          'color-picker': {
            ...
            clearable: 'Czy pokazywać przycisk czyszczenia, gdy wartość jest ustawiona.',
          ...
          'progress-bar': {
            ...
            buffer: 'Zbuforowana pozycja przed wartością, pokazana w kolorze dodatkowym.',
