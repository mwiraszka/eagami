...
export const pl: WebMessages = {
  ...
  ui: {
    ...
    icons: {
      ...
      title: 'Ikony',
      ledeBefore:
        'Samodzielne komponenty Angular, które dziedziczą kolor i skalują się wraz z',
      ledeAfter:
        ', dzięki czemu renderują się w dowolnym rozmiarze. Pochodzą z Feather Icons autorstwa Cole’a Bemisa i używane są na licencji MIT. Kliknij ikonę, aby skopiować jej selektor.',
