...
export const ru: WebMessages = {
  ...
  ui: {
    ...
    integrations: {
      ...
      intro:
        'Дизайн-токены не зависят от фреймворка. Скопируйте самодостаточное руководство по интеграции в проект без Angular или используйте машиночитаемый экспорт токенов напрямую.',
    ...
    accessibility: {
      metaTitle: 'Eagami | UI | Доступность',
      metaDescription:
      ...
      playground: {
        ...
        descriptions: {
          ...
          'number-input': {
            ...
            readonly: 'Делает поле только для чтения.',
            required: 'Помечает поле как обязательное.',
            min: 'Минимальное значение; введённые значения ограничиваются им при потере фокуса, и кнопки шага его учитывают.',
            max: 'Максимальное значение; введённые значения ограничиваются им при потере фокуса, и кнопки шага его учитывают.',
            step: 'Величина, которую каждый шаг (клавиша со стрелкой или кнопка шага) добавляет или вычитает.',
            id: 'id, применяемый к нативному input и атрибуту for метки, генерируется автоматически, если не задан.',
            value:
