      ...
      playground: {
        ...
        descriptions: {
          ...
          'data-table': {
            ...
            rowHref:
              'Задаёт каждой строке цель ссылки, размещённую настоящей ссылкой в каждой ячейке, чтобы браузер показывал и мог открыть её, а обычный щелчок по-прежнему вызывал rowActivate.',
            sizingRows:
