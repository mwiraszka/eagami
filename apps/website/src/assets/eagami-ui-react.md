...
version: 5.47.0
source: '@eagami/ui@5.47.0 (https://github.com/mwiraszka/eagami)'
 ...
 * Generated from @eagami/ui@5.47.0 (packages/ui/src/styles/tokens/*.scss)
 ...
 * Generated from @eagami/ui@5.47.0 by scripts/sync-integration-guides.mjs.
 * Do not edit by hand.
 */
...
The full icon set (450 icons). Single-color icons: `Activity`, `Airplay`, `AlertCircle`, `AlertOctagon`, `AlertTriangle`, `AlignCenter`, `AlignJustify`, `AlignLeft`, `AlignRight`, `Anchor`, `Aperture`, `Archive`, `Array`, `ArrowDown`, `ArrowDownCircle`, `ArrowDownLeft`, `ArrowDownRight`, `ArrowLeft`, `ArrowLeftCircle`, `ArrowRight`, `ArrowRightCircle`, `ArrowUp`, `ArrowUpCircle`, `ArrowUpLeft`, `ArrowUpRight`, `AspectRatio`, `AtSign`, `Award`, `BadgeCheck`, `BarChart`, `BarChart2`, `Battery`, `BatteryCharging`, `Bell`, `BellOff`, `BellRing`, `Bitcoin`, `Bluetooth`, `Bold`, `Book`, `BookOpen`, `Bookmark`, `BookmarkCheck`, `BookmarkPlus`, `Boombox`, `Bot`, `Bottle`, `Box`, `Brain`, `Briefcase`, `Bug`, `Building`, `Calculator`, `Calendar`, `CalendarCheck`, `CalendarDays`, `Camera`, `CameraOff`, `Candle`, `CassetteTape`, `Cast`, `Check`, `CheckCircle`, `CheckSquare`, `ChevronDown`, `ChevronLeft`, `ChevronRight`, `ChevronUp`, `ChevronsDown`, `ChevronsLeft`, `ChevronsRight`, `ChevronsUp`, `ChevronsUpDown`, `Circle`, `Clapperboard`, `Clipboard`, `ClipboardCheck`, `ClipboardList`, `Clock`, `Cloud`, `CloudDrizzle`, `CloudLightning`, `CloudOff`, `CloudRain`, `CloudSnow`, `Code`, `Coffee`, `Coins`, `Columns`, `Command`, `Compass`, `Contrast`, `Copy`, `CornerDownLeft`, `CornerDownRight`, `CornerLeftDown`, `CornerLeftUp`, `CornerRightDown`, `CornerRightUp`, `CornerUpLeft`, `CornerUpRight`, `CosineWave`, `Cpu`, `CreditCard`, `Crop`, `Crosshair`, `Database`, `Delete`, `Dice1`, `Dice2`, `Dice3`, `Dice4`, `Dice5`, `Dice6`, `Disc`, `Divide`, `DivideCircle`, `DivideSquare`, `DollarSign`, `DoubleExclamationMark`, `DoubleQuestionMark`, `Download`, `DownloadCloud`, `Droplet`, `Edit`, `Edit2`, `Edit3`, `Eject`, `ExclamationMark`, `ExclamationQuestionMark`, `ExternalLink`, `Eye`, `EyeOff`, `FastForward`, `Feather`, `File`, `FileAudio`, `FileCheck`, `FileImage`, `FileMinus`, `FilePdf`, `FilePlus`, `FileText`, `FileVideo`, `Film`, `Filter`, `FilterX`, `Fingerprint`, `FirstPlaceMedal`, `Flag`, `Flame`, `Folder`, `FolderMinus`, `FolderOpen`, `FolderPlus`, `Frown`, `Gauge`, `Gift`, `GitBranch`, `GitCommit`, `GitCompare`, `GitMerge`, `GitPullRequest`, `Globe`, `Grid`, `HalfCircle`, `HalfHeart`, `HardDrive`, `Hash`, `Headphones`, `Headset`, `Heart`, `HelpCircle`, `Heptagon`, `Hexagon`, `History`, `Home`, `Image`, `ImagePlay`, `ImagePlus`, `ImageSearch`, `Images`, `Inbox`, `Info`, `Italic`, `Key`, `Keyboard`, `Keyframe`, `Lamp`, `Languages`, `Laptop`, `Layers`, `Layout`, `Leaf`, `LeftHalfStar`, `LifeBuoy`, `Lightbulb`, `Link`, `Link2`, `List`, `ListChecks`, `Loader`, `Lock`, `LogIn`, `LogOut`, `Mail`, `MailCheck`, `Map`, `MapPin`, `Maximize`, `Maximize2`, `Megaphone`, `Meh`, `Menu`, `MessageCircle`, `MessageSquare`, `Mic`, `MicOff`, `MicVocal`, `Microscope`, `Minimize`, `Minimize2`, `Minus`, `MinusCircle`, `MinusSquare`, `Monitor`, `MonitorPlay`, `Moon`, `MoreHorizontal`, `MoreVertical`, `MousePointer`, `Move`, `Music`, `Navigation`, `Navigation2`, `Newspaper`, `Octagon`, `Package`, `Palette`, `Paperclip`, `Pause`, `PauseCircle`, `PenTool`, `Pentagon`, `Percent`, `Phone`, `PhoneCall`, `PhoneForwarded`, `PhoneIncoming`, `PhoneMissed`, `PhoneOff`, `PhoneOutgoing`, `PictureInPicture`, `PieChart`, `Pin`, `Play`, `PlayCircle`, `Playlist`, `Plug`, `Plus`, `PlusCircle`, `PlusSquare`, `Pocket`, `Podcast`, `Power`, `Printer`, `Projector`, `QrCode`, `QuestionExclamationMark`, `QuestionMark`, `Radio`, `RadioReceiver`, `RadioTower`, `Receipt`, `Record`, `RectangleHorizontal`, `RectangleVertical`, `Redo`, `RefreshCcw`, `RefreshCw`, `Repeat`, `Repeat1`, `Rewind`, `RightHalfStar`, `Rocket`, `RotateCcw`, `RotateCcwSquare`, `RotateCw`, `Rows`, `Rss`, `Save`, `Scan`, `Scissors`, `ScreenShare`, `Search`, `SecondPlaceMedal`, `Send`, `Server`, `Settings`, `Share`, `Shield`, `ShieldCheck`, `ShieldOff`, `ShoppingBag`, `ShoppingCart`, `Shuffle`, `Sidebar`, `SineWave`, `SkipBack`, `SkipForward`, `Slash`, `Sliders`, `Smartphone`, `Smile`, `Snowflake`, `SoccerBall`, `Sparkles`, `Speaker`, `Square`, `SquarePlay`, `Star`, `StepBack`, `StepForward`, `StopCircle`, `Subtitles`, `SubtitlesOff`, `Sun`, `Sunrise`, `Sunset`, `SwitchCamera`, `Table`, `Tablet`, `Tag`, `Target`, `Terminal`, `Thermometer`, `ThirdPlaceMedal`, `ThumbsDown`, `ThumbsUp`, `Timecode`, `Timer`, `ToggleLeft`, `ToggleRight`, `Tool`, `Transcode`, `Trash`, `Trash2`, `TrendingDown`, `TrendingUp`, `Triangle`, `Trim`, `Trophy`, `Truck`, `Tv`, `Type`, `Umbrella`, `Underline`, `Undo`, `Unlock`, `Upload`, `UploadCloud`, `User`, `UserCheck`, `UserMinus`, `UserPlus`, `UserX`, `Users`, `Video`, `VideoOff`, `Voicemail`, `Volume`, `Volume1`, `Volume2`, `VolumeX`, `Wallet`, `Wand`, `Watch`, `Waveform`, `Webcam`, `Wifi`, `WifiOff`, `Wind`, `X`, `XCircle`, `XOctagon`, `XSquare`, `Zap`, `ZapOff`, `ZoomIn`, `ZoomOut`.
