...
The full icon set (480 icons). Single-color icons: `Accessibility`, `Activity`, `Airplay`, `AlarmClock`, `AlertCircle`, `AlertOctagon`, `AlertTriangle`, `AlignCenter`, `AlignJustify`, `AlignLeft`, `AlignRight`, `Anchor`, `Aperture`, `Archive`, `Array`, `ArrowDown`, `ArrowDownCircle`, `ArrowDownLeft`, `ArrowDownRight`, `ArrowLeft`, `ArrowLeftCircle`, `ArrowLeftRight`, `ArrowRight`, `ArrowRightCircle`, `ArrowUp`, `ArrowUpCircle`, `ArrowUpDown`, `ArrowUpLeft`, `ArrowUpRight`, `AspectRatio`, `AtSign`, `Award`, `BadgeCheck`, `Ban`, `BarChart`, `BarChart2`, `Battery`, `BatteryCharging`, `Bell`, `BellOff`, `BellRing`, `Bitcoin`, `Bluetooth`, `Bold`, `Book`, `BookOpen`, `Bookmark`, `BookmarkCheck`, `BookmarkPlus`, `Boombox`, `Bot`, `Bottle`, `Box`, `Brain`, `Briefcase`, `Bug`, `Building`, `Calculator`, `Calendar`, `CalendarCheck`, `CalendarDays`, `CalendarPlus`, `Camera`, `CameraOff`, `Candle`, `CassetteTape`, `Cast`, `Check`, `CheckCheck`, `CheckCircle`, `CheckSquare`, `ChevronDown`, `ChevronLeft`, `ChevronRight`, `ChevronUp`, `ChevronsDown`, `ChevronsLeft`, `ChevronsRight`, `ChevronsUp`, `ChevronsUpDown`, `Circle`, `Clapperboard`, `Clipboard`, `ClipboardCheck`, `ClipboardList`, `ClipboardPaste`, `Clock`, `Cloud`, `CloudDrizzle`, `CloudLightning`, `CloudOff`, `CloudRain`, `CloudSnow`, `CloudSun`, `Code`, `Coffee`, `Coins`, `Columns`, `Command`, `Compass`, `Contrast`, `Cookie`, `Copy`, `CornerDownLeft`, `CornerDownRight`, `CornerLeftDown`, `CornerLeftUp`, `CornerRightDown`, `CornerRightUp`, `CornerUpLeft`, `CornerUpRight`, `CosineWave`, `Cpu`, `CreditCard`, `Crop`, `Crosshair`, `Crown`, `Database`, `Delete`, `Diamond`, `Dice1`, `Dice2`, `Dice3`, `Dice4`, `Dice5`, `Dice6`, `Disc`, `Divide`, `DivideCircle`, `DivideSquare`, `DollarSign`, `DoubleExclamationMark`, `DoubleQuestionMark`, `Download`, `DownloadCloud`, `Droplet`, `Edit`, `Edit2`, `Edit3`, `Eject`, `Euro`, `ExclamationMark`, `ExclamationQuestionMark`, `ExternalLink`, `Eye`, `EyeOff`, `FastForward`, `Feather`, `File`, `FileAudio`, `FileCheck`, `FileCode`, `FileImage`, `FileMinus`, `FilePdf`, `FilePlus`, `FileText`, `FileVideo`, `Film`, `Filter`, `FilterX`, `Fingerprint`, `FirstPlaceMedal`, `Flag`, `Flame`, `FlaskConical`, `Folder`, `FolderMinus`, `FolderOpen`, `FolderPlus`, `Forward`, `Frown`, `Gauge`, `Gift`, `GitBranch`, `GitCommit`, `GitCompare`, `GitMerge`, `GitPullRequest`, `Globe`, `GraduationCap`, `Grid`, `GripHorizontal`, `GripVertical`, `HalfCircle`, `HalfHeart`, `HardDrive`, `Hash`, `Headphones`, `Headset`, `Heart`, `HelpCircle`, `Heptagon`, `Hexagon`, `History`, `Home`, `Hourglass`, `Image`, `ImagePlay`, `ImagePlus`, `ImageSearch`, `Images`, `Inbox`, `Info`, `Italic`, `Key`, `Keyboard`, `Keyframe`, `Lamp`, `Languages`, `Laptop`, `Layers`, `Layout`, `LayoutDashboard`, `Leaf`, `LeftHalfStar`, `LifeBuoy`, `Lightbulb`, `Link`, `Link2`, `List`, `ListChecks`, `ListOrdered`, `Loader`, `Lock`, `LogIn`, `LogOut`, `Mail`, `MailCheck`, `Map`, `MapPin`, `Maximize`, `Maximize2`, `Megaphone`, `Meh`, `Menu`, `MessageCircle`, `MessageSquare`, `Mic`, `MicOff`, `MicVocal`, `Microscope`, `Minimize`, `Minimize2`, `Minus`, `MinusCircle`, `MinusSquare`, `Monitor`, `MonitorPlay`, `Moon`, `MoreHorizontal`, `MoreVertical`, `MousePointer`, `Move`, `Music`, `Navigation`, `Navigation2`, `Newspaper`, `Octagon`, `Package`, `Palette`, `Paperclip`, `Pause`, `PauseCircle`, `PenTool`, `Pentagon`, `Percent`, `Phone`, `PhoneCall`, `PhoneForwarded`, `PhoneIncoming`, `PhoneMissed`, `PhoneOff`, `PhoneOutgoing`, `PictureInPicture`, `PieChart`, `Pin`, `Plane`, `Play`, `PlayCircle`, `Playlist`, `Plug`, `Plus`, `PlusCircle`, `PlusSquare`, `Pocket`, `Podcast`, `Power`, `Printer`, `Projector`, `QrCode`, `QuestionExclamationMark`, `QuestionMark`, `Quote`, `Radio`, `RadioReceiver`, `RadioTower`, `Receipt`, `Record`, `RectangleHorizontal`, `RectangleVertical`, `Redo`, `RefreshCcw`, `RefreshCw`, `Repeat`, `Repeat1`, `Reply`, `Rewind`, `RightHalfStar`, `Rocket`, `RotateCcw`, `RotateCcwSquare`, `RotateCw`, `Rows`, `Rss`, `Save`, `Scan`, `Scissors`, `ScreenShare`, `Search`, `SecondPlaceMedal`, `Send`, `Server`, `Settings`, `Share`, `Share2`, `Shield`, `ShieldAlert`, `ShieldCheck`, `ShieldOff`, `ShoppingBag`, `ShoppingCart`, `Shuffle`, `Sidebar`, `SineWave`, `SkipBack`, `SkipForward`, `Slash`, `Sliders`, `Smartphone`, `Smile`, `Snowflake`, `SoccerBall`, `Sparkles`, `Speaker`, `Square`, `SquarePlay`, `Star`, `StepBack`, `StepForward`, `StopCircle`, `Strikethrough`, `Subtitles`, `SubtitlesOff`, `Sun`, `Sunrise`, `Sunset`, `SwitchCamera`, `Table`, `Tablet`, `Tag`, `Target`, `Terminal`, `Thermometer`, `ThirdPlaceMedal`, `ThumbsDown`, `ThumbsUp`, `Timecode`, `Timer`, `ToggleLeft`, `ToggleRight`, `Tool`, `Transcode`, `Trash`, `Trash2`, `TrendingDown`, `TrendingUp`, `Triangle`, `Trim`, `Trophy`, `Truck`, `Tv`, `Type`, `Umbrella`, `Underline`, `Undo`, `Unlink`, `Unlock`, `Upload`, `UploadCloud`, `User`, `UserCheck`, `UserCircle`, `UserMinus`, `UserPlus`, `UserX`, `Users`, `Video`, `VideoOff`, `Voicemail`, `Volume`, `Volume1`, `Volume2`, `VolumeX`, `Wallet`, `Wand`, `Watch`, `Waveform`, `Webcam`, `Wifi`, `WifiOff`, `Wind`, `X`, `XCircle`, `XOctagon`, `XSquare`, `Zap`, `ZapOff`, `ZoomIn`, `ZoomOut`.
