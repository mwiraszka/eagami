...
const messages: EagamiMessages = {
  ...
  colorPicker: {
    dialogLabel: 'Choisir une couleur',
  ...
  multiSelect: {
    dialogLabel: 'Choisir des options',
    placeholder: 'Sélectionner…',
  ...
  paginator: {
    ...
    page: page => `Aller à la page ${page}`,
  },
  progressBar: {
    label: 'Progression',
  },
  ...
  transferList: {
    ...
    empty: 'Aucun élément',
    moved: (count, listLabel) => `${count} déplacés vers ${listLabel}`,
  },
  validation: {
